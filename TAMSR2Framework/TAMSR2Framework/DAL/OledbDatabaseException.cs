/* **************************************************************
 * File Name        : OledbDatabaseException.cs
 * Description      : Exception Class for OledbDatabase Class
 * 
...
{
    /// <summary>
    /// Exception class for OledbDatabse
    /// </summary>
    public class OledbDatabaseException : ApplicationException
    {
        ...
        public OledbDatabaseException(string strMessage, int nErrorNum, Exception inner)
