/* **************************************************************
* File Name         : OracleDatabase.cs
* Description       : DB Component class for accessing and manipulating any Oracle DB-compliant data source
 * 
 * Author		    : Muhammad Aqeel Abbas @linktoaqeel
 * Created		    : May 22, 2013
 * Dependency	    : OracleDatabaseException class
...
{
    /// <summary>
    /// OracleDatabase: Oracle Database component implementing IConnectable interface.
    /// This component provides all methods for accessing Oracle database.
    /// All exceptions are rethrown to the calling page using OracleDatabaseException.
    /// (Original exception can be taken from the InnderException.)
    /// </summary>


    public class OracleDatabase : IConnectable
    {
        ...
        /// <summary>
        /// OracleDatabase Constructor with no parameters
        ...
        /// <summary>
        /// OracleDatbase Constructor - Connection String is passed as a string
        /// </summary>
        /// <param name="strConn">Connection String</param>
        public OracleDatabase(string strConn)
        {
        ...
        void IConnectable.Open()
        {
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.Open() failed, SqlException Occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.Open() Failed, Exception Occurred", 0, e);
            }
        ...
        void IConnectable.Close()
        {
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.Close() failed, SqlException Occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.Close() failed, Exception Occurred", 0, e);
            }
        }
        ...
        DataView IConnectable.ExecuteQuery(string strQuery)
        {
            ...
            try
            {
                OracleDataAdapter objCommand = new OracleDataAdapter(strQuery, objConnection);
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.ExecuteQuery() failed, SqlException Occurred", e.Code, e);
            }

            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.ExecuteQuery() failed, Exception Occurred", 0, e);
            }
        ...
        DataView IConnectable.ExecuteProcedure(string strProcedure, Hashtable htParameters)
        {
            ...
            try
            {
                OracleDataAdapter objCommand = new OracleDataAdapter(strProcedure, objConnection);
                ...
                {
                    objCommand.SelectCommand.Parameters.Add(new OracleParameter(objEnumerator.Key.ToString(), OracleType.NVarChar, 1024));
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.ExecuteProcedure() failed, SqlException Occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.ExecuteProcedure() failed, Exception Occurred", 0, e);
            }
        ...
        int IConnectable.ExecuteNonQuery(string strQuery)
        {
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.ExecuteNonQuery() failed, SqlException occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.ExecuteNonQuery() failed, Exception occurred", 0, e);
            }
            return nRecords;
        }
        ...
        int IConnectable.ExecuteNonQueryProcedure(string strProcedure, Hashtable htParameters)
        {
            ...
            try
            {
                ...
                OracleCommand objCommand = new OracleCommand(strProcedure, objConnection);
                objCommand.CommandTimeout = 120;
                IDictionaryEnumerator objEnumerator = htParameters.GetEnumerator();
                ...
                while (objEnumerator.MoveNext())
                {
                    objCommand.Parameters.Add(new OracleParameter(objEnumerator.Key.ToString(), OracleType.NVarChar, 1024));
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.ExecuteNonQueryProcedure() failed, SqlException Occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.ExecuteNonQueryProcedure() failed, Exception Occurred", 0, e);
            }
        ...
        /// database and it returns the primary key inserted. i.e @@IDENTITY.
        /// </summary>
        /// <param name="strProcedure">Stored Procedure Name to be executed </param>
        /// <param name="htParameters">Hash table which holds 0 or more parameters for the procedure </param>
        ...
        long IConnectable.GetValueNonQueryProcedure(string strProcedure, Hashtable htParameters)
        {
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.GetValueNonQueryProcedure() failed, SqlException occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.GetValueNonQueryProcedure() failed, Exception occurred", 0, e);
            }
        ...
        string IConnectable.GetValueProcedure(string strProcedure, Hashtable htParameters)
        {
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.GetValueProcedure() failed, SqlException Occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.GetValueProcedure() failed, Exception Occurred", 0, e);
            }
            return strValue;
        ...
        string IConnectable.GetValue(string strQuery)
        {
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.GetValue() failed, SqlException Occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.GetValue() failed, Exception Occurred", 0, e);
            }
            return strValue;
        ...
        void IConnectable.BeginTransaction()
        {
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.BeginTransaction() failed, SqlException occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.BeginTransaction() failed, Exception occurred", 0, e);
            }
        }
        ...
        void IConnectable.CommitTransaction()
        {
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.CommitTransaction() failed, SqlException occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.CommitTransaction() failed, Exception occurred", 0, e);
            }
        }
        ...
        void IConnectable.RollbackTransaction()
        {
            ...
            {
                throw new OracleDatabaseException("OracleDatabase.RollbackTransaction() failed, SqlException occurred", e.Code, e);
            }
            catch (Exception e)
            {
                throw new OracleDatabaseException("OracleDatabase.RollbackTransaction() failed, Exception occurred", 0, e);
            }
