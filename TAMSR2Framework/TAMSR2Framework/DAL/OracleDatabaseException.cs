/* **************************************************************
 * File Name        : OracleDatabaseException.cs
 * Description      : Exception Class for OracleDatabase Class
 * 
...
{
    /// <summary>
    /// OracleDatabaseException: Exception class for SqlDatabase
    /// </summary>
    public class OracleDatabaseException : ApplicationException
    {
        ...
        public OracleDatabaseException(string strMessage, int nErrorNum, Exception inner)
