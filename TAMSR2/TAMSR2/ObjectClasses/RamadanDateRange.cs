...
{
    public class RamadanDateRange : BaseClass
    {
        ...
        public int ProcessDataFlag { get; set; }


        public List<IdDateRangeList> GetRamadanDateRangesByMonth(string sessionID, string startDate, string endDate)
        {
            ...
            try
            {
                ...
                foreach (DataRowView row in dv)
                {
                    ...
                    obj.Reccuring = Numerics.GetInt(row["process_data_flag"] + "");
                    if (obj.Reccuring == 1)
                    {
