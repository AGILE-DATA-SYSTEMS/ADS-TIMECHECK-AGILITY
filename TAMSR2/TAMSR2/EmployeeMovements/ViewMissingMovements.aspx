<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewMissingMovements.aspx.cs" Inherits="TAMSR2.EmployeeMovements.ViewMissingMovements" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title><%=Resources.Resource.missingMovements %> - <%=Resources.Resource.applicationName %></title>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    <%=Resources.Resource.missingMovements %>	
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                    ...
                    <li><a href="#"><%=Resources.Resource.missingMovements %></a></li>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="portlet box light-grey">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.missingMovements %></div>
                        <div class="tools">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="btn-group pull-<%= pullDirectionStr %>" style="">
                                <span id="spnAddButton" runat="server" style="display: none;">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            <thead>
                                <tr style="background-color: #e8e3e3;">
                                    ...
                                    <th style="text-align: center;"><%=Resources.Resource.appliedIN %></th>
                                    <th style="text-align: center;"><%=Resources.Resource.status %></th>
                                    <th style="text-align: center;"><%=Resources.Resource.appliedOUT %></th>
                                    <th style="text-align: center;"><%=Resources.Resource.status %></th>
                                </tr>
                            </thead>
                            <tbody>
   ...
   <![endif]-->
    ...
    <script type="text/javascript">
        ...
        function LoadGrid(filter) {
            ...
            var urlStr = '<%= Page.ResolveClientUrl("../RequestPages/TAEventPage.aspx?key=GetAllMissingPunch") %>' + '&orgID=' + $("#ddOrg").val() + '&groupID=' + $("#ddEmpGroup").val() + '&empID=' + $("#ddEmp").val() + '&fromDate=' + fromDate + '&toDate=' + toDate;
            ...
            ////////Get Missing Transactions and load in grid/////////
       ...
       function Apply(transID, emp, mode, transDate) {
           var url = '<%= Page.ResolveClientUrl("~/Events/Save-Missing-Transaction") %>';
           url += '/' + transID + '/' + emp + '/' + mode + '/' + transDate;
          // alert(url);
           window.location = url;
       }
