    ...
    public partial class ViewUsers : System.Web.UI.Page
    {
        ...
        public void SetCultureValues()
        {
            ...
            catch (Exception ex)
            {
                ...
                new ExceptionLog().WriteLog("Admin/ViewUsers.aspx.SetCultureValues()", 0, ex);
            }
        }
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.ToLower().IndexOf("admin/viewusers.aspx"));
            if (Session["ID"] + "" == "")
                Response.Redirect(path + "Login.aspx");
            if (Session["RootUser"] + "" == "")
                Response.Redirect(path + "Common/Default.aspx");
            SetCultureValues();
