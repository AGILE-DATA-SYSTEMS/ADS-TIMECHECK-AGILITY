...
{
    public partial class CompanyWizard : System.Web.UI.Page
    {
        ...
        public void SetCultureValues()
        {
            ...
            catch (Exception ex)
            {
                ...
                new ExceptionLog().WriteLog("Admin/CompanyWizard.aspx.SetCultureValues()", 0, ex);
            }
        }
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf("Admin/CompanyWizard.aspx"));
            if (Session["ID"] + "" == "")
