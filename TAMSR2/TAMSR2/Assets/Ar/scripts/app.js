...
var App = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        function ToggleSidebar(sidebarStatus) {
            var d = "key=toggleSidebar&status=" + sidebarStatus;
            $.ajax({
                data: d,
                dataType: "json",
                cache: false,
                method: 'POST',
                url: '/RequestPages/SettingPage.aspx',
