<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewSecuritySummary.aspx.cs" Inherits="TAMSR2.Details.ViewSecuritySummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <title><%=Resources.Resource.security %> - <%=Resources.Resource.applicationName %></title> <link href="assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
            ...
            { %>         <div class="row-fluid">
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    ...
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Details/ViewRoles.aspx") %>'> &nbsp;<%= Resources.Resource.roles %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                             ...
                             <% if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_PRIVILEGE) == true)
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    ...
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Details/ViewPrivileges.aspx") %>'>  &nbsp; <%= Resources.Resource.privileges %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
