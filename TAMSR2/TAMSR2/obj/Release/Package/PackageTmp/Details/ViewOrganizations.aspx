<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewOrganizations.aspx.cs" Inherits="TAMSR2.Details.ViewOrganizations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.organization %></h4>
                     </div>
                     <div class="portlet-body form">
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal">
                           ...
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.parentOrganizationType %><span class="required">*</span></label>
                              <div class="controls chzn-controls">
                                 <select id="ddParentOrgType" style="width: 220px;" class="span6 chosen" data-with-diselect="1" name="orgType" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.company %>" tabindex="1">
                                    <option value=""></option>
                                 </select>
                              </div>
                           </div>
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.parentOrganization %></label>
                              <div class="controls chzn-controls">
                           ...
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.organizationType %><span class="required">*</span></label>
                              <div class="controls chzn-controls">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls"> 
                                        <input id="chkboxOpenShift" type="checkbox" name="branch" />
                                        <%=Resources.Resource.openShift %>
                                        <br />
                                        <span style="display:none;">
                                            <input id="chkboxInActive" type="checkbox" name="inactive" />
                                        ...
                                        <br />
                                        <span style="display: none;">
                                            <input id="chkboxBranch" type="checkbox" name="branch" />
         ...
         <div class="container-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#"><%=Resources.Resource.organizations %></a></li>					
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.organizations %></div>
                        <div class="tools">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr style="background-color: #e8e3e3;">
                                 ...
                                 <th style="text-align: center; max-width: 100px !important;"><%=Resources.Resource.code %></th>
                                 <th style="text-align: center;"><%=Resources.Resource.description %></th>
                                 <th style="text-align: center; max-width: 100px !important;"><%=Resources.Resource.type %></th>
                                 <th style="text-align: center;" class="hidden-480"><%=Resources.Resource.parent %></th>
                                 <th style="text-align: center; max-width: 100px !important;"><%=Resources.Resource.openShift %></th>
                                 <th style="text-align: center; max-width: 100px !important;"><%=Resources.Resource.inactiveDate %></th>
                                 <th style="text-align: center; max-width: 100px !important;"><%=Resources.Resource.updated %></th>
  ...
  <script src='../Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           $("#liOrgOrganization").addClass("active");
           ...
           var oTable = $('#sample_1').dataTable({
               ...
               "aLengthMenu": [
                   [10, 50, 100, 200, 500],
                   [10, 50, 100, 200, 500]// change per page values here
               ],
               "iDisplayLength": 10,
               "oLanguage": {
               ...
               "aaSorting": [[1, "desc"]],
               "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/OrgPage.aspx?key=getAll") %>'
           });
           ...
           $("#ddParentOrgType").change(function () {
               LoadOrganizations('');
           });
           LoadParentOrgTypes();
           LoadOrgTypes();
       ...
       function LoadOrganizations(orgID) {
           var d = "key=getIdNameListStringByType&type=" + $("#ddParentOrgType").val();
           //$("#form_sample_1").mask("<%=Resources.Resource.processing %>" + "....");
          $.ajax({
              type: 'POST',
              data: d,
              url: '<%= Page.ResolveClientUrl("../RequestPages/OrgPage.aspx") %>',
               success: function (html) {
                   $("#ddOrgParent").html(html);
                   $("#ddOrgParent").trigger("liszt:updated");
                   if (orgID != '') {
                       $('#ddOrgParent option[value=' + orgID + ']').attr('selected', 'selected');
                       $("#ddOrgParent").trigger("liszt:updated");
                   }
                   //$("#form_sample_1").unmask();
               },
       ...
       function LoadParentOrgTypes() {
           var d = "key=getIdNameListString";
           //$("#form_sample_1").mask("<%=Resources.Resource.processing %>" + "....");
           $.ajax({
               type: 'POST',
               data: d,
               url: '<%= Page.ResolveClientUrl("../RequestPages/OrgTypePage.aspx") %>',
              success: function (html) {
                  $("#ddParentOrgType").html(html);
                  $("#ddParentOrgType").trigger("liszt:updated");
                  //$("#form_sample_1").unmask();
              },
              error: function (html) {
                  $("#divErrorMsg").css("display", "block");
       ...
       function LoadOrgTypes() {
           var d = "key=getIdNameListStringOrgPage";
           //$("#form_sample_1").mask("<%=Resources.Resource.processing %>" + "....");
          $.ajax({
              type: 'POST',
              data: d,
              ...
              success: function (html) {
                   $("#ddOrgType").html(html);
                   $("#ddOrgType").trigger("liszt:updated");
                   //$("#form_sample_1").unmask();
               },
               error: function (html) {
                   $("#divErrorMsg").css("display", "block");
       ...
       function Clear() {
           ...
           $("#chkboxBranch").removeAttr("checked");
           $("#uniform-chkboxBranch span").removeClass("checked");

           $('#ddOrgParent option[value=""]').attr('selected', 'selected');
           $("#ddOrgParent").trigger("liszt:updated");

           $('#ddOrgType option[value=""]').attr('selected', 'selected');
           $("#ddOrgType").trigger("liszt:updated");
           //$("#txtCategory").val("");
           //$("#txtService").val("");
           ...
           $.ajax({
               ...
               success: function (html) {
                   if (html != "") {
                       ...
                       $("#txtCode").val(j.Code);
                       $('#ddParentOrgType option[value=' + j.ParentTypeID + ']').attr('selected', 'selected');
                       $("#ddParentOrgType").trigger("liszt:updated");
                       LoadOrganizations(j.ParentID);
                       $('#ddOrgType option[value=' + j.OrgTypeID + ']').attr('selected', 'selected');
                       $("#ddOrgType").trigger("liszt:updated");
       ...
       function Save() {
           ...
           var InactiveDate = $("#txtInactiveDate").val();

           if(InactiveDate != '')
               if (confirm('<%= Resources.Resource.msgInactiveChildOrgs %>') == false)
                   return;
           ...
           var parentID = $("#ddOrgParent").val();
           var orgTypeID = $("#ddOrgType").val();
           var branchFlag = $("#chkboxBranch").is(":checked");
           ...
           var v = "key=save" + "&id=" + id + "&code=" + code + "&parentID=" + parentID + "&orgTypeID=" + orgTypeID;
           v += "&descriptionEn=" + descriptionEn + "&descriptionAr=" + descriptionAr;
           v += "&branchFlag=" + branchFlag + "&openShift=" + openShift + "&InactiveDate=" + InactiveDate + "&monthlyMissedHours=" + monthlyMissedHours;
           ...
           $.ajax({
               ...
               success: function (html) {
                   ...
                   if (html == '-2') {
                       //failed
                       $("#divErrorMsg").css("display", "block");
                       $("#spnErrorMsg").html("<%=Resources.Resource.msgInactiveEmployeeExist %>");
                  }
                   else {
                       //success
       ...
       var FormComponents = function () {
           ...
           var handleDateTimePickers = function () {
               ...
               $("#txtInactiveDate").val('<%= new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).ToString("dd-MM-yyyy") %>');
               $("#txtInactiveDate").val('<%= DateTime.UtcNow.AddHours(4).ToString("dd-MM-yyyy") %>');
