<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewPermissionCancellationApproval.aspx.cs" Inherits="TAMSR2.Details.ViewPermissionCancellationApproval" %>



<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title><%=Resources.Resource.cancelPermissionApproval %> - <%=Resources.Resource.applicationName %></title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         ...
         <div class="container-fluid">
			...
			<h3 class="page-title">
									<%=Resources.Resource.permissionApproval %>	
							</h3>
			<ul class="breadcrumb">
				<li>
					<i class="icon-home"></i>
				...
				<li><a href="#"><%=Resources.Resource.cancelPermissionApproval %></a></li>					
               ...
               <div class="span12">
                  ...
                  <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.permissionApproval %></div>
                        <div class="tools">
  ...
  <script src='<%= path %>Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           $("#liPermissionApproval").addClass("active");
       ...
       function LoadGrid(filter){
           ...
           var url = '<%= Page.ResolveClientUrl("../RequestPages/SinglePermissionPage.aspx?key=getAllPending") %>' + '&fromDate=' + fromDate + '&toDate=' + toDate + '&status=' + status;
           var filterValue = "";
           if (filter == true) {
