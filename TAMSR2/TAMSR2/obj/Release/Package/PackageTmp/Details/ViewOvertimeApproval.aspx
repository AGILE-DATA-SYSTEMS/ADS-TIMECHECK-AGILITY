<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewOvertimeApproval.aspx.cs" Inherits="TAMSR2.Details.ViewOvertimeApproval" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><%=Resources.Resource.approveovertime %> - <%=Resources.Resource.applicationName %></title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- BEGIN PAGE CONTAINER-->        
         <div class="container-fluid">
			...
			<h3 class="page-title">
									<%=Resources.Resource.approveovertime %>	
							</h3>
			<ul class="breadcrumb">
				<li>
					<i class="icon-home"></i>
				...
				<li><a href="#"><%=Resources.Resource.approveovertime %></a></li>					
                ...
                <!-- END FORM-->
                  ...
                  <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.approveovertime %></div>
                        <div class="tools">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr style="background-color: #e8e3e3;">
                                 ...
                                 <th style="text-align: center;"><%=Resources.Resource.workingdays %></th>
                                 <th style="text-align: center;"><%=Resources.Resource.restdays %></th>
  ...
  <script src='<%= path %>Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           $("#liOvertimeApproval").addClass("active");
       ...
       function LoadGrid(filter) {
           var url = '<%= Page.ResolveClientUrl("../RequestPages/OvertimePage.aspx?key=getAllPending") %>';
       ...
       function Approve() {
           var v = "key=approvePendingOvertime&";
       ...
       function Reject() {
           var v = "key=rejectPendingOvertime&";
