<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewManualTransaction.aspx.cs" Inherits="TAMSR2.Details.ViewManualTransaction" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title><%=Resources.Resource.appliedMovements %> - <%=Resources.Resource.applicationName %></title>
    ...
    <style>
       ...
       #sample_1.table {width:100% !important}
    </style>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    <%=Resources.Resource.appliedMovements %>	
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                    ...
                    <li><a href="#"><%=Resources.Resource.appliedMovements %></a></li>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="portlet box light-grey">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.appliedMovements %></div>
                        <div class="tools">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="btn-group pull-<%= pullDirectionStr %>">
                                <span id="spnAddButton" runat="server" visible="false">
                                    <a id="btnAdd" onclick="return Clear()" style="display: none;" href='<%= Page.ResolveClientUrl("~/Events/Save-Manual-Punch/") %>' data-toggle="modal" class="btn green"><i class="icon-plus">&nbsp; <%=Resources.Resource.add %></i></a>
                                </span>
   ...
   <![endif]-->
    ...
    <script type="text/javascript">
       ...
       function Delete() {
           var v = "key=deleteManualMissingPunchByID&";
       ...
       function GetLabel() {
        ...
        function LoadGrid(filter) {
            ...
            //  alert(status);
            var urlStr = '<%= Page.ResolveClientUrl("../RequestPages/TAEventPage.aspx?key=GetAllManualPunch") %>' + '&orgID=' + $("#ddOrg").val() + '&groupID=' + $("#ddEmpGroup").val() + '&empID=' + $("#ddEmp").val() + '&fromDate=' + fromDate + '&toDate=' + toDate + '&status=' + status
            //  alert(urlStr);
            ...
            var oTable = $('#sample_1').dataTable({
                ...
                "aoColumns": [
                  ...
                  { "bSortable": true, sClass: "classDataTable", sWidth: "5%" },
