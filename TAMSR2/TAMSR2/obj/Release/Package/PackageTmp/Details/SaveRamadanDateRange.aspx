<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SaveRamadanDateRange.aspx.cs" Inherits="TAMSR2.Details.SaveRamadanDateRange" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title><%=Resources.Resource.ramadanDateRange %> - <%=Resources.Resource.applicationName %></title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    <%=Resources.Resource.ramadanDateRange %>	
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                    ...
                    <li><a href='<%= Page.ResolveClientUrl("~/Sch/Ramadan-Date-Range-View") %>'><%=Resources.Resource.ramadanDateRanges %></a></li>
   ...
   <![endif]-->
    ...
    <script type="text/javascript">
        ...
        function CloseForm() {
            Clear();
            window.location = '<%= Page.ResolveClientUrl("~/Sch/Ramadan-Date-Range-View") %>';
            $("#divSuccessMsg").hide();
        }
