<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="error-500.aspx.cs" Inherits="TAMSR2.ErrorPages.error_500" %>



<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
  <title><%=Resources.Resource.error500 %> - <%=Resources.Resource.applicationName %></title>
