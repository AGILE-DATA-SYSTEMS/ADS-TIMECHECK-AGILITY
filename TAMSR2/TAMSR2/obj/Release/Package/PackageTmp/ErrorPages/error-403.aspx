...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="error-403.aspx.cs" Inherits="TAMSR2.ErrorPages.error_403" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
  <title><%=Resources.Resource.error403 %> - <%=Resources.Resource.applicationName %></title>
               ...
               <div class="span12">
                  <div class="row-fluid page-500">
                     ...
                     <div class="span7 details">
                        <h3>Forbidden</h3>
                        <p>
                           You don't have neccessary permissions to access this location,<br /> if you have permission and still facing this page then contact administrator about this.<br />
