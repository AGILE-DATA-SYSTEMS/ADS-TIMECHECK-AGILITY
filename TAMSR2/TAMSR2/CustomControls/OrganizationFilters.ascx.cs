...
{
    public partial class OrganizationFilters : System.Web.UI.UserControl
    {
        ...
        public void SetCultureValues()
        {
            ...
            catch (Exception ex)
            {
                ...
                new ExceptionLog().WriteLog("CustomControls/OrganizationFilters.asax.SetCultureValues()", 0, ex);
            }
        }
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //path = url.Substring(0, url.ToLower().IndexOf("customcontrols/organizationfilters.asax"));
            //if (Session["ID"] + "" == "")
