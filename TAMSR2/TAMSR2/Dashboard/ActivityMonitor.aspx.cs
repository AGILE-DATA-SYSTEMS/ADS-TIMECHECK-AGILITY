...
{
    public partial class ActivityMonitor : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_ACTIVITY_MONITOR) == false)
            {
            ...
            if (url.ToLower().Contains("activitymonitor.aspx"))
                path = url.Substring(0, url.ToLower().IndexOf("dashboard/activitymonitor.aspx"));
            else
                path = url.Substring(0, url.ToLower().IndexOf("dashboard/activity-monitor"));
