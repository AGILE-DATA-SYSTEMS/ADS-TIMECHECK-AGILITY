...
namespace TAMSR2.RequestPages
{
    public partial class RegionPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.ToLower().IndexOf(@"requestpages/regionpage.aspx"));
            ...
            {
                data = GetCodeNameListStringForReportFilters();
            }
            else
            {
                data = "";
        ...
        public string GetByID()
        {
            ...
            try
            {
                ...
                if (dv != null)
                {
                    obj.ID = Numerics.GetDecimal(dv[0]["region_id"]);
                    obj.Code = dv[0]["region_code"] + "";
        ...
        #region GetCodeNameListStringForReportFilters
        /// <summary>
        /// GetCodeNameListStringForReportFilters function
        /// Get user by ID from Regions table 
        /// </summary>
        /// <returns>it will return parsed json object</returns>
        public string GetCodeNameListStringForReportFilters()
        {
            TAMSR2Data objDAL = new TAMSR2Data();
            DataView dv = new DataView();
            ...
            try
            {
                ...
                Hashtable ht = new Hashtable();
                ht.Add("action", "getIdNameListForReportFilters");
                ht.Add("sessionID", Session["ID"] + "");
                dv = objDAL.Connection.ExecuteProcedure("TAMSR2_RegionOps", ht);
        ...
        //*********End Of GetCodeNameListStringForReportFilters Function*********//
        #endregion
        ...
        public string DeleteByID()
        {
            ...
            try
            {
                ...
                int temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_RegionOps", ht);
                if (temp > 0)
                    return "1";
                else
                    return "0";
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/RegionPageaspx.DeleteByID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAll()
        {
            ...
            try
            {
                ...
                string[] cols = { "region_id", "region_code", "description" + languagePostfix, "last_updated_date", "region_id" };
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_RegionOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_RegionOps", ht));
                json.iTotalDisplayRecords = json.iTotalRecords;

                foreach (DataRowView obj in objDataView)
                {
                    List<string> tempList = new List<string>();
                    tempList.Add("<input type='checkbox' class='checkboxes' value='" + Numerics.GetDecimal(obj["region_id"]) + "' />");
                    tempList.Add(obj["region_code"] + "");
                    ...
                    string tempAction = "";
                    tempAction = "";
                    if (new TAMSPrivilege().IsPrivileged(TAMSPrivilege.EDIT_REGION) == true || Numerics.GetBool(Session["CanUpdate"]) == true)
                    {
                        tempAction = "<img src='" + path + "images/edit.png' title='Edit' alt='Edit' onclick='return Edit(" + Numerics.GetDecimal(obj["region_id"]) + ");' /> &nbsp; ";
                    }
                    if (Numerics.GetBool(Session["CanDelete"]) == true || true)
                    {
                        //tempAction += "<img src='" + path + "images/delete.png' alt='Delete' title='Delete' onclick='Delete(" + Numerics.GetDecimal(obj["region_id"]) + ")' /> ";
                    }
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/RegionPageaspx.GerAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            ...
            try
            {
                ...
                string result = objDAL.Connection.GetValueProcedure("TAMSR2_RegionOps", ht);
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/RegionPageaspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
