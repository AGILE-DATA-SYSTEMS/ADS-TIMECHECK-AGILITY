...
{
    public partial class EmployeeTypePage : System.Web.UI.Page
    {
        string url = "";
        string path = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/EmployeeTypePage.aspx"));
        ...
        public string GetByID()
        {
            ...
            try
            {
                ...
                dv = objDAL.Connection.ExecuteProcedure("TAMSR2_EmpTypeOps", ht);

                if (dv != null)
                {
                    obj.ID = Numerics.GetDecimal(dv[0]["employee_type_id"]);
                    obj.Code = dv[0]["employee_type_code"] + "";
        ...
        public string GetIdNameListString()
        {
            ...
            try
            {
                ...
                {
                    EmployeeType obj = new EmployeeType();
                    obj.ID = Numerics.GetDecimal(row["employee_type_id"] + "");
                    obj.Code = row["employee_type_code"] + "";
        ...
        public string DeleteByID()
        {
            ...
            try
            {
                ...
                int temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_EmpTypeOps", ht);
                if (temp > 0)
                    return "1";
                else
                    return "0";
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/EmployeeTypePage.aspx.DeleteByID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAll()
        {
            ...
            try
            {
                ...
                string[] cols = { "empType.employee_type_id", "empType.employee_type_code", "empType.description" + languagePostfix, "empType.last_updated_date", "empType.employee_type_id" };
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_EmpTypeOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_EmpTypeOps", ht));
                json.iTotalDisplayRecords = json.iTotalRecords;

                foreach (DataRowView obj in objDataView)
                {
                    List<string> tempList = new List<string>();
                    tempList.Add("<input type='checkbox' class='checkboxes' value='" + Numerics.GetDecimal(obj["employee_type_id"]) + "' />");
                    tempList.Add(obj["employee_type_code"] + "");
                    ...
                    string tempAction = "";
                    tempAction = "";
                    if (new TAMSPrivilege().IsPrivileged(TAMSPrivilege.EDIT_EMP_TYPE) == true || Numerics.GetBool(Session["CanUpdate"]) == true)
                    {
                        tempAction = "<img src='" + path + "images/edit.png' title='Edit' alt='Edit' onclick='return Edit(" + Numerics.GetDecimal(obj["employee_type_id"]) + ");' /> &nbsp; ";
                    }
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/EmployeeTypePage.aspx.GerAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            ...
            try
            {
                ...
                string result = objDAL.Connection.GetValueProcedure("TAMSR2_EmpTypeOps", ht);
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/EmployeeTypePage.aspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
