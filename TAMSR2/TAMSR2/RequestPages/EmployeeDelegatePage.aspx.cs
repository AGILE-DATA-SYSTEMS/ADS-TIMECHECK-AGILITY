...
{
    public partial class EmployeeDelegatePage : System.Web.UI.Page
    {
        string url = "";
        string path = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/EmployeeDelegatePage.aspx"));
            ...
            else if (Request["key"] + "" == "viewDelegatedFeatues")
            {
                data = ViewDelegatedFeatues();
            }
        ...
        public string GetByID()
        {
            ...
            EmployeeDelegate obj = new EmployeeDelegate();
            try
            {
                ...
                ht.Add("ID", id);
                dv = objDAL.Connection.ExecuteProcedure("TAMSR2_DelegateOps", ht);

                if (dv != null)
                {
                    obj.ID = Numerics.GetDecimal(dv[0]["delegate_id"]);
                    obj.EmployeeID = Numerics.GetDecimal(dv[0]["employee_id"]);
                    obj.DelegatedEmployeeID = Numerics.GetDecimal(dv[0]["delegated_employee_id"]);
        ...
        #region ViewDelegatedFeatues
        /// <summary>
        /// ViewDelegatedFeatues function
        /// 
        /// </summary>
        /// <returns>it will return parsed json object</returns>
        public string ViewDelegatedFeatues()
        {
            string id = "0";
            ...
            try
            {
                ...
                Hashtable ht = new Hashtable();
                ht.Add("action", "viewDelegatedFeatues");
                ht.Add("sessionID", Session["ID"] + "");
                ht.Add("ID", id);
                dv = objDAL.Connection.ExecuteProcedure("TAMSR2_DelegateOps", ht);
        ...
        public string DeleteByID()
        {
            ...
            try
            {
                ...
                int temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_DelegateOps", ht);
                if (temp > 0)
                    return "1";
                else
                    return "0";
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/EmployeeDelegatePage.aspx.DeleteByID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        {
            string features = (String)GetGlobalResourceObject("Resource", "features");
            ...
            try
            {
                ...
                string[] cols = { "d.delegate_id", "emp.employee_code", "emp.name" + languagePostfix, "d.delegate_id", "org.description" + languagePostfix, "d.from_date", "d.to_date", "d.status", "d.delegate_id" };
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_DelegateOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_DelegateOps", ht));
                ...
                foreach (DataRowView obj in objDataView)
                {
                    ...
                    tempList.Add("<input type='checkbox' class='checkboxes' value='" + Numerics.GetDecimal(obj["delegate_id"]) + "' />");
                    //if (dt < Numerics.GetDateTime(obj["from_date"] + ""))
                    //    tempList.Add("<input type='checkbox' class='checkboxes' value='" + Numerics.GetDecimal(obj["delegate_id"]) + "' />");
                    //else
                    //    tempList.Add("&nbsp;");
                    tempList.Add((obj["empCode"] + "").Trim());
                    ...
                    tempList.Add("<img style='width: 32px; height: 32px; cursor: pointer; text-decoration: none;' src='" + path + "images/features.png' onclick='return ViewDelegatedFeatues(" + Numerics.GetDecimal(obj["delegate_id"]) + ");' title='" + features + "' alt='" + features + "' /> &nbsp; </a>");

                    //tempList.Add((obj["ftrDesc" + languagePostfix] + "").Length > 100 ? (obj["ftrDesc" + languagePostfix] + "").Substring(0, 100) + "..." : (obj["ftrDesc" + languagePostfix] + ""));
                    tempList.Add((obj["delegateEmpName" + languagePostfix] + "").Length > 100 ? (obj["delegateEmpName" + languagePostfix] + "").Substring(0, 100) + "..." : (obj["delegateEmpName" + languagePostfix] + ""));
                    ...
                    string tempAction = "";
                    tempAction = "";
                    if (new TAMSPrivilege().IsPrivileged(TAMSPrivilege.EDIT_DELEGATE) == true || Numerics.GetBool(Session["CanUpdate"]) == true)
                    {
                        tempAction = "<a style='text-decoration: none;' href='" + path + "Emp/Save-Employee-Delegate/" +
                                        Encryption.Encrypt(obj["delegate_id"] + "") + "'>" +
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/EmployeeDelegatePage.aspx.GetAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
      ...
      //      ht.Add("featureID", (Request["featureID"] + "").Trim());
            ht.Add("DelegatedEmpID", (Request["DelegatedEmpID"] + "").Trim());
            ...
            try
            {
                ...
                string result = objDAL.Connection.GetValueProcedure("TAMSR2_DelegateOps", ht);
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/EmployeeDelegatePage.aspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
