...
{
    public partial class DeviceConnectionPage : System.Web.UI.Page
    {
        string url = "";
        string path = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/DeviceConnectionPage.aspx"));
        ...
        public string GetByID()
        {
            ...
            try
            {
                ...
                dv = objDAL.Connection.ExecuteProcedure("TAMSR2_DeviceConnectionOps", ht);
        ...
        public string GetIdNameListString()
        {
            ...
            try
            {
                ...
                string deviceConnectionStr = (String)GetGlobalResourceObject("Resource", "deviceConnection");

                sb.Append("<option value=''>" + chooseStr + " " + deviceConnectionStr + "</option>");

                foreach (DataRowView row in dv)
                {
                    EmployeeType obj = new EmployeeType();
                    obj.ID = Numerics.GetDecimal(row["connection_id"] + "");
                    obj.Code = row["code"] + "";
                    obj.DescriptionEn = row["connection_name"] + "";
                    obj.DescriptionAr = row["connection_name"] + "";
                    if (cookie.Values["language"] == "ar")
        ...
        public string DeleteByID()
        {
            ...
            try
            {
                ...
                int temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_DeviceConnectionOps", ht);
                if (temp > 0)
                    return "1";
                else
                    return "0";
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/DeviceConnectionPage.aspx.DeleteByID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAll()
        {
            ...
            try
            {
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_DeviceConnectionOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_DeviceConnectionOps", ht));
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/DeviceConnectionPage.aspx.GerAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            ...
            try
            {
                ...
                string result = objDAL.Connection.GetValueProcedure("TAMSR2_DeviceConnectionOps", ht);
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/DeviceConnectionPage.aspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
