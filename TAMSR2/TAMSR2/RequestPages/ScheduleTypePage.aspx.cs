...
{
    public partial class ScheduleTypePage : System.Web.UI.Page
    {
        string url = "";
        string path = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/ScheduleTypePage.aspx"));
        ...
        public string GetByID()
        {
            ...
            try
            {
                ...
                dv = objDAL.Connection.ExecuteProcedure("TAMSR2_ScheduleTypeOps", ht);

                if (dv != null)
                {
                    obj.ID = Numerics.GetDecimal(dv[0]["schedule_type_id"]);
        ...
        public string GetIdNameListString()
        {
            ...
            try
            {
                ...
                string orgTypeStr = (String)GetGlobalResourceObject("Resource", "scheduleType");
                ...
                {
                    OrgType obj = new OrgType();
                    obj.ID = Numerics.GetDecimal(row["schedule_type_id"] + "");
        ...
        public string DeleteByID()
        {
            ...
            try
            {
                ...
                int temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_ScheduleTypeOps", ht);
                if (temp > 0)
                    return "1";
                else
                    return "0";
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/ScheduleTypePage.aspx.DeleteByID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAll()
        {
            ...
            try
            {
                ...
                string[] cols = { "schedule_type_id", "description" + languagePostfix, "last_updated_date", "schedule_type_id" };
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_ScheduleTypeOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_ScheduleTypeOps", ht));
                json.iTotalDisplayRecords = json.iTotalRecords;

                foreach (DataRowView obj in objDataView)
                {
                    List<string> tempList = new List<string>();
                    if (Numerics.GetDecimal(obj["schedule_type_id"]) >= 0 && Numerics.GetDecimal(obj["schedule_type_id"]) <= 2)
                        tempList.Add(" &nbsp;");
                    else
                        tempList.Add("<input type='checkbox' class='checkboxes' value='" + Numerics.GetDecimal(obj["schedule_type_id"]) + "' />");
                    ...
                    {
                        if (Numerics.GetDecimal(obj["schedule_type_id"]) > 2 && (
                                new TAMSPrivilege().IsPrivileged(TAMSPrivilege.EDIT_SCHEDULE_TYPES) == true 
                                || Numerics.GetBool(Session["CanUpdate"]) == true)
                            )
                        {
                            tempAction = "<img src='" + path + "images/edit.png' title='Edit' alt='Edit' onclick='return Edit(" + Numerics.GetDecimal(obj["schedule_type_id"]) + ");' /> &nbsp; ";
                        }
                        else
                        {
                            tempAction = " &nbsp;";
                        ...
                        {
                            //tempAction += "<img src='" + path + "images/delete.png' alt='Delete' title='Delete' onclick='Delete(" + Numerics.GetDecimal(obj["schedule_type_id"]) + ")' /> ";
                        }
                    }
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/ScheduleTypePage.aspx.GerAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            ...
            try
            {
                ...
                string result = objDAL.Connection.GetValueProcedure("TAMSR2_ScheduleTypeOps", ht);
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/ScheduleTypePage.aspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
