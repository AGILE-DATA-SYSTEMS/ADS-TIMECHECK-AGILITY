...
{
    public partial class ZonesPage : System.Web.UI.Page
    {
        string url = "";
        string path = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/ZonesPage.aspx"));
        ...
        public string GetByID()
        {
            ...
            try
            {
                ...
                if (dv != null)
                {
                    obj.ID = Numerics.GetDecimal(dv[0]["zone_id"]);
        ...
        public string DeleteByID()
        {
            ...
            try
            {
                ...
                int temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_ZonesOps", ht);
                if (temp > 0)
                    return "1";
                else
                    return "0";
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/ZonesPage.aspx.DeleteByID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAll()
        {
            ...
            try
            {
                ...
                string[] cols = { "zn.zone_id", "zn.code", "zn.description" + languagePostfix, "zn.is_active", "zn.is_deleted", "zn.updated_date", "zn.zone_id" };
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_ZonesOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_ZonesOps", ht));
                json.iTotalDisplayRecords = json.iTotalRecords;

                foreach (DataRowView obj in objDataView)
                {
                    List<string> tempList = new List<string>();
                    tempList.Add("<input type='checkbox' class='checkboxes' value='" + Numerics.GetDecimal(obj["zone_id"]) + "' />");
                    ...
                    {
                        tempAction = "<img src='" + path + "images/edit.png' title='Edit' alt='Edit' onclick='return Edit(" + Numerics.GetDecimal(obj["zone_id"]) + ");' /> &nbsp; ";
                    }
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/ZonesPage.aspx.GetAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            ...
            try
            {
                ...
                string result = objDAL.Connection.GetValueProcedure("TAMSR2_ZonesOps", ht);
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/ZonesPage.aspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
