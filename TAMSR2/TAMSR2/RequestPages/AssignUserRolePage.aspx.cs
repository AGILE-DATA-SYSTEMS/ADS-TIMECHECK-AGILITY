...
{
    public partial class AssignUserRolePage : System.Web.UI.Page
    {
        string url = "";
        string path = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/AssignUserRolePage.aspx"));
        ...
        public string RemoveGroupMembers()
        {
            ...
            try
            {
                ...
                temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_UserRoleMemberOps", ht);
            }
            catch (Exception ex)
            {
                new ExceptionLog().WriteLog("RequestPages/AssignUserRolePage.aspx.RemoveGroupMembers()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string AssignGroupMembers()
        {
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/AssignUserRolePage.aspx.AssignGroupMembers()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAllMembersByOrgIDGroupID()
        {
            ...
            try
            {
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_UserRoleMemberOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearchFilter"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_UserRoleMemberOps", ht));
                json.iTotalDisplayRecords = json.iTotalRecords;
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/AssignUserRolePage.aspx.GetAllMembersByOrgIDGroupID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAllEmployeesByOrgIDGroupID()
        {
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/AssignUserRolePage.aspx.GetAllEmployeesByOrgIDGroupID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAll()
        {
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/AssignUserRolePage.aspx.GetAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/AssignUserRolePage.aspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
