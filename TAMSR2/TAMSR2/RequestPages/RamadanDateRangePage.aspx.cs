...
{
    public partial class RamadanDateRangePage : System.Web.UI.Page
    {
        string url = "";
        string path = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/RamadanDateRangePage.aspx"));
        ...
        public string GetByID()
        {
            ...
            RamadanDateRange obj = new RamadanDateRange();
            try
            {
                ...
                ht.Add("ID", id);
                dv = objDAL.Connection.ExecuteProcedure("TAMSR2_RamadanDateRangeOps", ht);

                if (dv != null)
                {
                    obj.ID = Numerics.GetDecimal(dv[0]["id"]);
                    obj.ProcessDataFlag = Numerics.GetInt(dv[0]["process_data_flag"] + "");
        ...
        public string DeleteByID()
        {
            ...
            try
            {
                ...
                int temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_RamadanDateRangeOps", ht);
                if (temp > 0)
                    return "1";
                else
                    return "0";
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/RamadanDateRangePage.aspx.DeleteByID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAll()
        {
            ...
            try
            {
                ...
                string[] cols = { "h.id", "h.description" + languagePostfix, "h.from_date", "h.to_date", "h.last_updated_date", "h.id" };
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_RamadanDateRangeOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_RamadanDateRangeOps", ht));
                ...
                foreach (DataRowView obj in objDataView)
                {
                    ...
                    if (Numerics.GetDecimal(obj["process_data_flag"] + "") == 1)
                    ...
                    string tempAction = "";
                    tempAction = "";
                    if (new TAMSPrivilege().IsPrivileged(TAMSPrivilege.EDIT_RAMADAN_DATE_RANGE) == true || Numerics.GetBool(Session["CanUpdate"]) == true)
                    {
                        tempAction = "<a style='text-decoration: none;' href='" + path + "Sch/Save-Ramadan-Date-Range/" +
                                        Encryption.Encrypt(obj["id"] + "") + "'>" +
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/RamadanDateRangePage.aspx.GetAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            string chk = "0";
            int recurring = 0;
            if ((Request["recurring"] + "").Trim().ToLower() == "true")
                recurring = 1;
            string id = "0";
            try
            {
            ...
            try
            {
                ...
                string result = objDAL.Connection.GetValueProcedure("TAMSR2_RamadanDateRangeOps", ht);
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/RamadanDateRangePage.aspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
