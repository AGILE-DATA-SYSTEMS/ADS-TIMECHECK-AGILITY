...
namespace TAMSR2.RequestPages
{
    public partial class ReasonPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/ReasonPage.aspx"));
            ...
            else if (Request["key"] + "" == "getByModeIdNameListString")
            {
                data = GetByModeIdNameListString();
            }
            else
            {
                data = "";
        ...
        public string GetByID()
        {
            ...
            try
            {
                ...
                if (dv != null)
                {
                    ...
                    obj.WebPunch = Numerics.GetBool(dv[0]["web_punch"] + "");
        ...
        public string GetIdNameListString()
        {
            ...
            try
            {
                ...
                {
                    Reason obj = new Reason();
                    obj.ID = Numerics.GetDecimal(row["reason_id"] + "");
                    obj.Code = row["code"] + "";
        ...
        #region GetByModeIdNameListString
        /// <summary>
        /// GetByModeIdNameListString function
        ///  
        /// </summary>
        /// <returns>it will return parsed json object</returns>
        public string GetByModeIdNameListString()
        {
            TAMSR2Data objDAL = new TAMSR2Data();
            DataView dv = new DataView();
            StringBuilder sb = new StringBuilder();
            ...
            try
            {
                ...
                Hashtable ht = new Hashtable();
                ht.Add("action", "getByModeIdNameList");
                ht.Add("sessionID", Session["ID"] + "");
                ht.Add("reasonMode", Request["mode"] + "");
                dv = objDAL.Connection.ExecuteProcedure("TAMSR2_ReasonOps", ht);
        ...
        //*********End Of GetByModeIdNameListString Function*********//
        #endregion
        ...
        public string DeleteByID()
        {
            ...
            try
            {
                ...
                int temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_ReasonOps", ht);
                if (temp > 0)
                    return "1";
                else
                    return "0";
        ...
        {
            string rIN = (String)GetGlobalResourceObject("Resource", "rIN");
            string rOUT = (String)GetGlobalResourceObject("Resource", "rOUT");
            ...
            try
            {
                ...
                string[] cols = { "r.reason_id", "r.code", "r.description" + languagePostfix, "r.reason_mode", "r.prompt_message", "r.deletable", "r.normal_in", "r.normal_out", "r.last_updated_date", "r.reason_id" };
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_ReasonOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_ReasonOps", ht));
                json.iTotalDisplayRecords = json.iTotalRecords;

                foreach (DataRowView obj in objDataView)
                {
                    List<string> tempList = new List<string>();
                    if (Numerics.GetDecimal(obj["deletable"] + "") != 0)
                    ...
                    tempList.Add(Numerics.GetDecimal(obj["reason_mode"] + "") == 1 ? rIN : rOUT);
                    tempList.Add(obj["prompt_message"] + "");
                    if (Numerics.GetDecimal(obj["deletable"] + "") == 1)
                        tempList.Add("<i class='icon-ok'></i>");
                    else
                        tempList.Add("<i class='icon-remove'></i>");
                    if (Numerics.GetDecimal(obj["normal_in"] + "") == 1)
                        tempList.Add("<i class='icon-ok'></i>");
                    else
                        tempList.Add("<i class='icon-remove'></i>");
                    if (Numerics.GetDecimal(obj["normal_out"] + "") == 1)
                        tempList.Add("<i class='icon-ok'></i>");
                    else
                        tempList.Add("<i class='icon-remove'></i>");
                    if (Numerics.GetBool(obj["web_punch"] + "") == true)
                        tempList.Add("<i class='icon-ok'></i>");
                    else
                        tempList.Add("<i class='icon-remove'></i>");
                    ...
                    string tempAction = "";
                    tempAction = "";
                    if (new TAMSPrivilege().IsPrivileged(TAMSPrivilege.EDIT_REASON) == true || Numerics.GetBool(Session["CanUpdate"]) == true)
                    {
                        tempAction = "<img src='" + path + "images/edit.png' title='Edit' alt='Edit' onclick='return Edit(" + Numerics.GetDecimal(obj["reason_id"]) + ");' /> &nbsp; ";
                    }
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/ReasonPage.aspx.GerAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            ...
            if ((Request["webPunch"] + "").ToLower() == "true")
                webPunch = 1;
            if ((Request["id"] + "").Trim() == "" || (Request["id"] + "").Trim() == "0")
                deleteable = 1;
            Hashtable ht = new Hashtable();
            ht.Add("action", "save");
            ht.Add("sessionID", Session["ID"] + "");
            ...
            try
            {
                ...
                string result = objDAL.Connection.GetValueProcedure("TAMSR2_ReasonOps", ht);
