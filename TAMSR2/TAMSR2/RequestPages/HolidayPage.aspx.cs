...
{
    public partial class HolidayPage : System.Web.UI.Page
    {
        string url = "";
        string path = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/HolidayPage.aspx"));
        ...
        public string GetByID()
        {
            ...
            try
            {
                ...
                if (dv != null)
                {
                    ...
                    obj.PublicHolidayFlag = Numerics.GetInt(dv[0]["Public_Holiday"] + "");
        ...
        public string DeleteByID()
        {
            ...
            try
            {
                ...
                int temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_HolidayOps", ht);
                if (temp > 0)
                    return "1";
                else
                    return "0";
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/HolidayPage.aspx.DeleteByID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAll()
        {
            ...
            try
            {
                ...
                string[] cols = { "h.holiday_id", "h.description" + languagePostfix, "h.from_date", "h.to_date", "h.last_updated_date", "h.holiday_id" };
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_HolidayOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_HolidayOps", ht));
                ...
                foreach (DataRowView obj in objDataView)
                {
                    ...
                    if (Numerics.GetDecimal(obj["recurring_flag"] + "") == 1)
                        tempList.Add("<i class='icon-ok'></i>");
                    else
                        tempList.Add("<i class='icon-remove'></i>");

                    if (Numerics.GetDecimal(obj["Public_Holiday"] + "") == 1)
                        tempList.Add("<i class='icon-ok'></i>");
                    else
                        tempList.Add("<i class='icon-remove'></i>");
                    ...
                    {
                        tempAction = "<a style='text-decoration: none;' href='" + path + "Common/Save-Holiday/" +
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/HolidayPage.aspx.GetAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            ...
            if ((Request["publicHoliday"] + "").Trim().ToLower() == "true")
                publicHoliday = 1;
            ...
            ht.Add("PublicHoliday", publicHoliday);
            ...
            try
            {
                ...
                string result = objDAL.Connection.GetValueProcedure("TAMSR2_HolidayOps", ht);
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/HolidayPage.aspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
