...
{
    public partial class CountryPage : System.Web.UI.Page
    {
        string url = "";
        string path = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/CountryPage.aspx"));
        ...
        public string DeleteByID()
        {
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/CountryPage.aspx.DeleteByID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAll()
        {
            ...
            try
            {
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_CountryOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_CountryOps", ht));
                ...
                foreach (DataRowView obj in objDataView)
                {
                    ...
                    string tempAction = "";
                    tempAction = "";
                    if (new TAMSPrivilege().IsPrivileged(TAMSPrivilege.EDIT_COUNTRY) == true || Numerics.GetBool(Session["CanUpdate"]) == true)
                    {
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/CountryPage.aspx.GerAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/CountryPage.aspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
