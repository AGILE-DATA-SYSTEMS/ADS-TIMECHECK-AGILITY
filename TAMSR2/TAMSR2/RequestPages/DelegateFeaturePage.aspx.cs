...
{
    public partial class DelegateFeaturePage : System.Web.UI.Page
    {
        string url = "";
        string path = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.IndexOf(@"RequestPages/DelegateFeaturePage.aspx"));
            ...
            else if (Request["key"] + "" == "getFeatureListNotDelegetedByID")
            {
                data = GetFeatureListNotDelegetedByID();
            }
            else if (Request["key"] + "" == "getFeatureListDelegetedByID")
            {
                data = GetFeatureListDelegetedByID();
            }
            else
            {
                data = "";
        ...
        public string GetByID()
        {
            ...
            DelegateFeature obj = new DelegateFeature();
            try
            {
                ...
                if (dv != null)
                {
                    obj.ID = Numerics.GetDecimal(dv[0]["feature_id"]);
        ...
        public string GetIdNameListString()
        {
            ...
            try
            {
                ...
                string featureStr = (String)GetGlobalResourceObject("Resource", "feature");

                sb.Append("<option value=''>" + chooseStr + " " + featureStr + "</option>");

                foreach (DataRowView row in dv)
                {
                    DelegateFeature obj = new DelegateFeature();
                    obj.ID = Numerics.GetDecimal(row["feature_id"] + "");
        ...
        #region getFeatureListNotDelegetedByID
        /// <summary>
        /// getFeatureListNotDelegetedByID function
        /// 
        /// </summary>
        /// <returns>it will return parsed json object</returns>
        public string GetFeatureListNotDelegetedByID()
        {
            TAMSR2Data objDAL = new TAMSR2Data();
            DataView dv = new DataView();
            StringBuilder sb = new StringBuilder();
            ...
            try
            {
                ...
                Hashtable ht = new Hashtable();
                ht.Add("action", "getFeatureListNotDelegetedByID");
                ht.Add("sessionID", Session["ID"] + "");
        ...
        #region getFeatureListDelegetedByID
        /// <summary>
        /// getFeatureListDelegetedByID function
        /// 
        /// </summary>
        /// <returns>it will return parsed json object</returns>
        public string GetFeatureListDelegetedByID()
        {
            TAMSR2Data objDAL = new TAMSR2Data();
            DataView dv = new DataView();
            StringBuilder sb = new StringBuilder();
            ...
            try
            {
                ...
                Hashtable ht = new Hashtable();
                ht.Add("action", "getFeatureListDelegetedByID");
                ht.Add("sessionID", Session["ID"] + "");
                ht.Add("ID", Request["rID"] + "");
                dv = objDAL.Connection.ExecuteProcedure("TAMSR2_DelegateOps", ht);
        ...
        public string DeleteByID()
        {
            ...
            try
            {
                ...
                int temp = objDAL.Connection.ExecuteNonQueryProcedure("TAMSR2_FeatureOps", ht);
                if (temp > 0)
                    return "1";
                else
                    return "0";
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/DelegateFeaturePage.aspx.DeleteByID()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string GetAll()
        {
            ...
            try
            {
                ...
                string[] cols = { "feature_id", "code", "description" + languagePostfix, "status", "updated_date", "feature_id" };
                ...
                ht.Add("endRow", end);
                DataView objDataView = objDAL.Connection.ExecuteProcedure("TAMSR2_FeatureOps", ht);
                ...
                ht.Add("searchInput", (Request["sSearch"] + "").Trim());
                ht.Add("orderBy", orderByClause);
                json.iTotalRecords = Numerics.GetInt(objDAL.Connection.GetValueProcedure("TAMSR2_FeatureOps", ht));
                json.iTotalDisplayRecords = json.iTotalRecords;

                foreach (DataRowView obj in objDataView)
                {
                    List<string> tempList = new List<string>();
                    tempList.Add("<input type='checkbox' class='checkboxes' value='" + Numerics.GetDecimal(obj["feature_id"]) + "' />");
                    ...
                    tempList.Add(Numerics.GetBool(obj["status"] + "") + "");
                    ...
                    {
                        tempAction = "<img src='" + path + "images/edit.png' title='Edit' alt='Edit' onclick='return Edit(" + Numerics.GetDecimal(obj["feature_id"]) + ");' /> &nbsp; ";
                    }
                    if (Numerics.GetBool(Session["CanDelete"]) == true || true)
                    {
                        //tempAction += "<img src='" + path + "images/delete.png' alt='Delete' title='Delete' onclick='Delete(" + Numerics.GetDecimal(obj["feature_id"]) + ")' /> ";
                    }
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/DelegateFeaturePage.aspx.GetAll()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
        ...
        public string Save()
        {
            string chk = "0";
            string status = "0";
            if ((Request["status"] + "").ToLower() == "true")
                status = "1";
            ...
            try
            {
                ...
                string result = objDAL.Connection.GetValueProcedure("TAMSR2_FeatureOps", ht);
            ...
            {
                new ExceptionLog().WriteLog("RequestPages/DelegateFeaturePage.aspx.Save()", 0, ex);
            }
            finally
            {
                objDAL.CloseConnection();
