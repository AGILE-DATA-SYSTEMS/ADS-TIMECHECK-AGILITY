...
{
    public partial class AddDptAdmins : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (url.ToLower().Contains("adddptadmins.aspx"))
                path = url.Substring(0, url.ToLower().IndexOf("dptadmins/adddptadmins.aspx"));
            else
                path = url.Substring(0, url.ToLower().IndexOf("emp/save-department-admins"));
