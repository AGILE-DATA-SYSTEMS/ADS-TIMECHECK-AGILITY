...
namespace TAMSR2.Details
{
    public partial class ViewSchedules : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (url.ToLower().Contains("viewschedules.aspx"))
                path = url.Substring(0, url.ToLower().IndexOf("details/viewschedules.aspx"));
            else
                path = url.Substring(0, url.ToLower().IndexOf("sch/schedules"));
