<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewReasons.aspx.cs" Inherits="TAMSR2.Details.ViewReasons" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <title><%=Resources.Resource.reasons %> - <%=Resources.Resource.applicationName %></title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.reason %></h4>
                     </div>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal">
                           ...
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.reasonMode %><span class="required">*</span></label>
                               <div class="controls">
                                   <select id="ddReasonMode" style="width: 220px;" name="sex" class="span6 chosen" data-with-diselect="1" name="org" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.sex %>" tabindex="1">
                                       <option value="1"><%=Resources.Resource.rIN %> </option>
                                       <option value="2"><%=Resources.Resource.rOUT %> </option>
                                   </select>
                               </div>
                           </div>
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.promptMsg %><span class="required">*</span></label>
                              <div class="controls">
                                 <input name="promptMsg" id="txtPromptMsg" type="text" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group" style="display: none;">
                              ...
                              <div class="controls">
                                    <label class="radio line">
                                        <input type="radio" id="rdBtnNormalIn" value="normalIn" name="reasonType" style="opacity: 0;">
                                        <%=Resources.Resource.normalIn %>
                                    </label>
                                    <label class="radio line">
                                        <input type="radio" id="rdBtnNormalOut" value="normalOut" name="reasonType" style="opacity: 0;">
                                        <%=Resources.Resource.normalOut%>
                                    </label>
                              </div>
                           </div>
                            <div class="control-group">
                            ...
                            <div class="control-group" style="display: none;">
                                <label class="control-label">&nbsp;</label>
                                <div class="controls">
                                    <input id="chkboxDeleteable" type="checkbox" name="deleteable" />
                                    <%=Resources.Resource.deleteable %>
                                </div>
                            </div>
         ...
         <div class="container-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#"><%=Resources.Resource.reasons %></a></li>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.reasons %></div>
                        <div class="tools">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr style="background-color: #e8e3e3;">
                                 ...
                                 <th style="text-align: center;" class="hidden-480"><%=Resources.Resource.reasonMode %></th>
                                 <th style="text-align: center;" class="hidden-480"><%=Resources.Resource.promptMsg %></th>
                                 <th style="text-align: center;" class="hidden-480"><%=Resources.Resource.deleteable %></th>
                                 <th style="text-align: center;" class="hidden-480"><%=Resources.Resource.normalIn %></th>
                                 <th style="text-align: center;" class="hidden-480"><%=Resources.Resource.normalOut %></th>
                                 <th style="text-align: center;" class="hidden-480"><%=Resources.Resource.webPunch %></th>
  ...
  <script src='../Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           $("#liGeneralReason").addClass("active");
           ...
           var oTable = $('#sample_1').dataTable({
               ...
               "aaSorting": [[1, "desc"]],
               "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/ReasonPage.aspx?key=getAll") %>'
           });
           ...
           $.connection.hub.start().done(function () {
               $('#btnBroadCast').click(function () {
                   ...
                   users.server.send('TAMSR2_Cmp_Reasons', '');
       ...
       function Clear() {
           ...
           $("#chkboxDeleteable").removeAttr("checked");
           $("#uniform-chkboxDeleteable span").removeClass("checked");

           $("#rdBtnNormalIn").removeAttr("checked");
           $("#uniform-rdBtnNormalIn span").removeClass("checked");

           $("#rdBtnNormalOut").removeAttr("checked");
           $("#uniform-rdBtnNormalOut span").removeClass("checked");
           ...
           $.ajax({
               ...
               success: function (html) {
                   if (html != "") {
                       ...
                       $('#ddReasonMode option[value=' + j.ReasonMode + ']').attr('selected', 'selected');
                       $("#ddReasonMode").trigger("liszt:updated");
                       $("#txtPromptMsg").val(j.PromptMsg);
                       if (j.WebPunch + "" == "true") {
                           $("#chkboxWebPunch").attr("checked", "checked");
                           $("#uniform-chkboxWebPunch span").addClass("checked");
                       }
                       if (j.Deleteable + "" == "1") {
                           $("#chkboxDeleteable").attr("checked", "checked");
                           $("#uniform-chkboxDeleteable span").addClass("checked");
                       }
                       if (j.NormalIn + "" == "1") {
                           $("#rdBtnNormalIn").attr("checked", "checked");
                           $("#uniform-rdBtnNormalIn span").addClass("checked");
                       }
                       if (j.NormalOut + "" == "1") {
                           $("#rdBtnNormalOut").attr("checked", "checked");
                           $("#uniform-rdBtnNormalOut span").addClass("checked");
                       }
                   }
               },
               error: function (html) {
       ...
       function Save() {
           ...
           var type = $("input:radio[name=reasonType]:checked").val();
           var id = $("#spnID").html();
           var descriptionEn = $("#txtDescriptionEn").val();
           var descriptionAr = $("#txtDescriptionAr").val();
           var code = $("#txtCode").val();
           var promptMsg = $("#txtPromptMsg").val();
           var reasonMode = $("#ddReasonMode").val();
           var webPunch = $("#chkboxWebPunch").is(":checked");
           var deleteable = $("#chkboxDeleteable").is(":checked");
           if ($('#form_sample_1').validate().form() == false) {
               return false;
           }
           var v = "key=save" + "&id=" + id + "&descriptionEn=" + descriptionEn + "&descriptionAr=" + descriptionAr + "&code=" + code;
           v += "&promptMsg=" + promptMsg + "&reasonMode=" + reasonMode + "&deleteable=" + deleteable + "&type=" + type;
           v += "&webPunch=" + webPunch;
