<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SaveDelegation.aspx.cs" Inherits="TAMSR2.Details.SaveDelegation" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href='<%= Page.ResolveClientUrl("~/Emp/Employee-Delegate") %>'><%=Resources.Resource.delegation %></a></li>
            ...
            <div class="span12">
                ...
                <form action="#" id="form_sample_1" class="form-horizontal">
                    ...
                    <div class="row-fluid">
                        <div class="span6 ">
                            <div class="control-group" style="display:none;">
                                ...
                                <div class="controls chzn-controls">
                                    <select id="ddOrgFilter" style="width: 220px;" class="span6 chosen" data-with-diselect="1" name="orgFilter" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.organization %>" tabindex="1">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="span6 ">
                            <div class="control-group">
                                <label class="control-label"><%=Resources.Resource.delegatedEmployee %><span class="required">*</span></label>
                                <div class="controls chzn-controls" style="width: 220px; display:none">
                                    <select id="ddOrg" style="width: 220px; display:none" class="span6 chosen" data-with-diselect="1" name="org" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.delegateOrganization %>" tabindex="1">
                                        <option value=""></option>
                                    </select>
                                </div>
                                <div class="controls chzn-controls">
                                    <select id="ddDelegatedEmp" style="width: 220px;" class="span6 chosen" data-with-diselect="1" name="delegatedEmp" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.employee %>" tabindex="1">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row-fluid">
                        <div class="span6 ">
                            <div class="control-group" >
                               ...
                               <div class="controls">
                                   <input id="chkboxStatus" type="checkbox" name="status" /> <%=Resources.Resource.status %>
                               </div>
                           </div>
                        </div>
                        <!--/span-->
                                      ...
                                      <table style="width: 100%;">
                                          <tr>
                                              <td style="padding: 0px 5px;">
                                                  <div class="control-group" style="font-weight: bold; text-align: center !important;"><%=Resources.Resource.allFeatures %></div>
                                              </td>
                                              <td style="padding: 0px 5px;"></td>
                                              <td style="padding: 0px 5px;">
                                                  <div class="control-group" style="font-weight: bold; text-align: center !important;"><%=Resources.Resource.selectedFeatures %></div>
                                              </td>
                                          </tr>
                                          <tr>
                                              <td style="padding: 0px 5px; width: 45%;">
                                                  <select id="ddFromFeature" name="ddFromFeature" style="width: 95%; min-height: 200px !important;" tabindex="1" data-placeholder="Choose a Category" multiple="multiple" class="span6 m-wrap">
                                                  </select>
                                              </td>
                                              <td style="padding: 0px 5px; width: 10%;">
                                                  <div>
                                                      <input type="button" id="addFeature" onclick="AddFeature()" value="  >>  " />
                                                      <br />
                                                      <br />
                                                      <br />
                                                      <input type="button" id="removeFeature" onclick="RemoveFeature()" value="  <<  " />
                                                  </div>
                                              </td>
                                              <td style="padding: 0px 5px; width: 45%;">
                                                  <select id="ddToFeature" name="ddToFeature" style="width: 95%; min-height: 200px !important;" tabindex="1" data-placeholder="Choose a Category" multiple="multiple" class="span6 m-wrap">
                                                  </select>
                                              </td>
                                          </tr>
                                      </table>
   ...
   <![endif]-->
    ...
    <script type="text/javascript">
        ...
        function LoadEmployeeList() {
            var d = "key=getAllIdNameListByOrgID&orgID=" + $("#ddOrgFilter").val();
            //$("#form_sample_1").mask("<%=Resources.Resource.processing %>" + "....");
            $.ajax({
                type: 'POST',
                data: d,
                ...
                success: function (html) { 
                    ...
                    $("#ddDelegatedEmp").html(html);
                    $("#ddDelegatedEmp option[value=<%= Session["ID"] + "" %>]").remove();
                    $("#ddDelegatedEmp").trigger("liszt:updated");
            ...
            $.ajax({
                ...
                url: '<%= Page.ResolveClientUrl("../RequestPages/EmployeePage.aspx") %>',
                 success: function (html) {
                     ...
                     $('#ddEmployee option[value=' + <%= Session["ID"] + "" %> + ']').attr('selected', 'selected');
        ...
        function GetFeaturesNotInDelegByDelegID(dID) {
           ...
           $.ajax({
               ...
               success: function (html) {
                   $("#ddFromFeature").html(html);
                   $("#ddFromFeature option[value='']").remove();
                   $("#ddFromFeature").trigger("liszt:updated");
               },
               error: function (html) {
                   $("#divErrorMsg").css("display", "block");
                   $("#spnErrorMsg").html("<%=Resources.Resource.msgError %>");
        ...
        function AddFeature() {
            var arr = $("#ddFromFeature").val();
            var txt = $("#ddFromFeature option:selected").text();

            $.each(arr, function (index, val) {
                $('#ddToFeature').append($('<option>', {
                    value: val,
                    text: $("#ddFromFeature option[value='" + val + "']").text()
                }));
                $("#ddFromFeature option[value='" + val + "']").remove();
            });
        }

        function RemoveFeature() {
            var arr = $("#ddToFeature").val();
            var txt = $("#ddToFeature option:selected").text();

            $.each(arr, function (index, val) {
                $('#ddFromFeature').append($('<option>', {
                    value: val,
                    text: $("#ddToFeature option[value='" + val + "']").text()
                }));
                $("#ddToFeature option[value='" + val + "']").remove();
            });
        }
        ...
        function GetFeaturesInDelegByDelegID(dID) {
           ...
           $.ajax({
               ...
               url: '<%= Page.ResolveClientUrl("../RequestPages/DelegateFeaturePage.aspx") %>',
               success: function (html) {
                   $("#ddToFeature").html(html);
                   $("#ddToFeature option[value='']").remove();
                   $("#ddToFeature").trigger("liszt:updated");
               },
               error: function (html) {
                   $("#divErrorMsg").css("display", "block");
                   $("#spnErrorMsg").html("<%=Resources.Resource.msgError %>");
        ...
        function CloseForm() {
            window.location = '<%= Page.ResolveClientUrl("~/Emp/Employee-Delegate") %>';
        }
            ...
            $.ajax({
                ...
                success: function (html) {
                    if (html != "") {
                        ...
                        $('#ddDelegatedEmp option[value=' + j.DelegatedEmployeeID + ']').attr('selected', 'selected');
                        $("#ddDelegatedEmp").trigger("liszt:updated");
                        if (j.Status + "" == "true") {
                            $("#chkboxStatus").attr("checked", "checked");
                            $("#uniform-chkboxStatus span").addClass("checked");
                     ...
                     //   GetFeaturesNotInDelegByDelegID(j.ID);
                     //   GetFeaturesInDelegByDelegID(j.ID);
                    }
                },
                error: function (html) {
        ...
        function Save() {
            ...
            var delegatedEmpID = $("#ddDelegatedEmp").val();

            //var valuesToFeature = $.map($('#ddToFeature option'), function (e) { return e.value; });
            //var featureID = valuesToFeature.toString();
            ...
            selectedDate = selectedDate.slice(0, 4) + "-" + selectedDate.slice(4,6) + "-" + selectedDate.slice(6,8);
            var today = '<%= DateTime.Now.ToString("yyyy-MM-dd") %>';
             
            if (new Date(selectedDate) < new Date(today)) {
                $("#divErrorMsg").css("display", "block");
                $("#spnErrorMsg").html("<%=Resources.Resource.msgEndDateError %>");
                return false;
            }
            ...
            var v = "key=save" + "&id=" + id + "&empID=" + empID + "&DelegatedEmpID=" + delegatedEmpID; //+ "&featureID=" + featureID;
            v += "&fromDate=" + fromDate + "&toDate=" + toDate + "&remarks=" + remarks + "&status=" + status;
            ...
            $.ajax({
                ...
                success: function (html) {
                    if (html == '-1') {
                        ...
                        //exists
                        $("#divErrorMsg").css("display", "block");
                        $("#spnErrorMsg").html("<%=Resources.Resource.msgAlreadyDelegated %>");
                    }
                    else if (html == '0') {
                        //exists
                        $("#divErrorMsg").css("display", "block");
