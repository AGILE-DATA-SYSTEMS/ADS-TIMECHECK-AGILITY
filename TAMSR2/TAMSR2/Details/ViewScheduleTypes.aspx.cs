...
{
    public partial class ViewScheduleTypes : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (url.ToLower().Contains("viewscheduletypes.aspx"))
                path = url.Substring(0, url.ToLower().IndexOf("details/viewscheduletypes.aspx"));
            else
                path = url.Substring(0, url.ToLower().IndexOf("sch/schedule-types"));
