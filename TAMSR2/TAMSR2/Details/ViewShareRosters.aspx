<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewShareRosters.aspx.cs" Inherits="TAMSR2.Details.ViewShareRosters" %>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.shareRoster %></h4>
                        </div>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#"><%=Resources.Resource.shareRoster %></a></li>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="portlet box light-grey">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.shareRoster %></div>
                        <div class="tools">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="btn-group pull-<%= pullDirectionStr %>" style="">
                                <span id="spnAddButton" runat="server">
                                    <a id="btnAdd" onclick="return Clear()" href='<%= Page.ResolveClientUrl("~/Sch/Save-Share-Schedule-Roster/" + TAMSR2.CustomClasses.Encryption.Encrypt("0")) %>' class="btn green"><i class="icon-plus">&nbsp; <%=Resources.Resource.add %></i></a>
                                </span>
                                <span id="spnDeleteButton" runat="server">
                                    <a id="btnDelete" onclick="return Revoke()" style='margin: 0px 10px;' class="btn red"><i class="icon-trash">&nbsp; <%=Resources.Resource.revoke %></i></a>
                                </span>
                            </div>
                        </div>
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            <thead>
                              <tr style="background-color: #e8e3e3;">
                                    ...
                                    <th style="text-align: center;"><%=Resources.Resource.managerID %></th>
                                    <th style="text-align: center;"><%=Resources.Resource.firstManager %></th>
                                    <th style="text-align: center;"><%=Resources.Resource.costCenter %></th>
                                    <th style="text-align: center;"><%=Resources.Resource.managerID %></th>
                                    <th style="text-align: center;"><%=Resources.Resource.secondManager %></th>
                                    <th style="text-align: center;"><%=Resources.Resource.costCenter %></th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var oTable = $('#sample_1').dataTable({
                ...
                "aaSorting": [[1, "desc"]],
                "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/ShareRosterPage.aspx?key=getAll") %>'
            });
        ...
        function Revoke() {
            ...
            if (confirm("<%=Resources.Resource.confirmRevokeShareRoster %>")) {
                $.ajax({
                    type: 'POST',
                    data: v,
                   ...
                   success: function (html) {
                       if (html == "1") {
                           ...
                           $("#spnSuccessMsg2").html("<%=Resources.Resource.msgRevokeShareRosterSuccess %>");
                           $('#btnBroadCast').click();
                       }
                       else {
                           $("#divErrorMsg2").css("display", "block");
                           $("#spnErrorMsg2").html("<%=Resources.Resource.msgRevokeShareRosterFailed %>");
                       }
                   },
                   error: function (html) {
