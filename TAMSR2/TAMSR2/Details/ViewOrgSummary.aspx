<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewOrgSummary.aspx.cs" Inherits="TAMSR2.Details.ViewOrgSummary" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
       <title><%=Resources.Resource.organization %> - <%=Resources.Resource.applicationName %></title> <link href="assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <!-- BEGIN PAGE CONTAINER-->
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title" style="margin: 0px;"><%=Resources.Resource.organization %> 					<small style="display: none;">statistics and more</small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                            ...
                            <li><a href="#"><%=Resources.Resource.organization %> </a></li>
            ...
            <div class="clearfix"></div>
                <div id="dashboard" style="min-height:100px;">
               ...
               <div class="clearfix"></div>
               <div class="row-fluid">
                  <div class="span6" style="width:98%; margin-left:50px; margin-right:50px;">
                     <div class="portlet">
                            ...
                            <%   if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_ORGANIZATION) == true)
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    ...
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Details/ViewOrganizations.aspx") %>'> &nbsp;<%= Resources.Resource.organization %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number visits"  data-percent="10"><span>10</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Details/ViewOrganizationTypes.aspx") %>'>  &nbsp; <%= Resources.Resource.organizationTypes %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                        </div>
                         <% } %>
