...
{
    public partial class ViewCounteries : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            url = Request.Url.AbsoluteUri;
            if (url.ToLower().Contains("viewcounteries.aspx"))
                path = url.Substring(0, url.ToLower().IndexOf("details/viewcounteries.aspx"));
            else
