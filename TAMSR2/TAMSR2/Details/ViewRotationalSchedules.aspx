<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewRotationalSchedules.aspx.cs" Inherits="TAMSR2.Details.ViewRotationalSchedules" %>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.rotationalSchedule %></h4>
                        </div>
                        <div class="portlet-body form">
                            ...
                            <form action="#" id="form_sample_1" class="form-horizontal">
                                ...
                                <div style="width: 100%; overflow: hidden; overflow-y: hidden; padding: 20px 0px;">
                                    <table class="table table-striped table-bordered table-hover" style="width:100% !important" id="RotationalDetails">
                                        <thead>
                                            <tr style="background-color: #e8e3e3;">
                                                <th>Day</th>
                                                <th>Schedule Id</th>
                                                <th class="hidden-480">Schedule Code</th>
                                                <th class="hidden-480">Schedule Color</th>
                                                <th class="hidden-480"><%=Resources.Resource.timeIn %></th>
                                                <th class="hidden-480"><%=Resources.Resource.timeOut %></th>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#"><%=Resources.Resource.rotationalSchedule %></a></li>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="portlet box light-grey">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.rotationalSchedule %></div>
                        <div class="tools">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                    <tr style="background-color: #e8e3e3;">
                                        ...
                                        <th class="hidden-480">Scope</th>
                                        <th class="hidden-480">Number Of Schedules</th>
    ...
    <script type="text/javascript">
       ...
       function LoadGroups() {
        ...
        function LoadGrid() {
            if ($("#ddOrg").val() == "" && $("#ddEmpGroup").val() == "" && $("#ddEmp").val() == "")
                return;
            var urlStr = '<%= Page.ResolveClientUrl("../RequestPages/RotationalSchedulePage.aspx?key=getAll") %>' + '&orgID=' + $("#ddOrg").val() + '&groupID=' + $("#ddEmpGroup").val() + '&empID=' + $("#ddEmp").val();
       ...
       function AddSchedule() {
           ...
           var urlStr = '<%= Page.ResolveClientUrl("~/Sch/Save-Rotational-Schedule") %>';
        ...
        function GetRotationalScheduleDetail(id) {
            $('#RotationalDetails').css("width", "100%");
            ...
            var urlStr = '<%= Page.ResolveClientUrl("../RequestPages/RotationalSchedulePage.aspx?key=getRotationalScheduleDetailById") %>'
                + '&orgID=' + $("#ddOrg").val() + '&groupID=' + $("#ddEmpGroup").val()
                + '&empID=' + $("#ddEmp").val() +'&ScheduleRotationalId='+ scheduleRotationalId
            ////////Get Users and load in grid/////////
            var oTable = $('#RotationalDetails').dataTable({
                  "bProcessing": true,
                  "bServerSide": true,
                  "bDestroy": true,
                  "sPaginationType": "bootstrap",
        ...
        function Edit(id, fromDate) {
            ...
            if (groupID == "")
                groupID = "-1";
            urlStr += '/' + id + '/' + orgID + '/' + empID + '/' + groupID + '/' + fromDate;
            window.location = urlStr;
        }
        ...
        function Delete() {
            ...
            var empID = $("#ddEmp").val();
            var groupID = $("#ddEmpGroup").val();
            var v = "key=deleteRotationalScheduleById" + '&orgID=' + orgID + '&empID=' + empID + '&groupID=' + groupID + '&';
