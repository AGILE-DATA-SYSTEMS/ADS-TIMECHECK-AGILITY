...
{
    public partial class SaveRamadanDateRange : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (url.ToLower().Contains("saveramadandaterange.aspx"))
                path = url.Substring(0, url.ToLower().IndexOf("details/saveramadandaterange.aspx"));
            else
                path = url.Substring(0, url.ToLower().IndexOf("sch/save-ramadan-date-range"));
