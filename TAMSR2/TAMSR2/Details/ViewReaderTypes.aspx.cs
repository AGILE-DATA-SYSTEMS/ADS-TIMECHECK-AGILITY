...
{
    public partial class ViewReaderTypes : System.Web.UI.Page
    {
        ...
        public void SetCultureValues()
        {
            ...
            catch (Exception ex)
            {
                ...
                new ExceptionLog().WriteLog("Details/ViewReaderTypes.aspx.SetCultureValues()", 0, ex);
            }
        }
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            path = url.Substring(0, url.ToLower().IndexOf("details/viewreadertypes.aspx"));
            if (Session["ID"] + "" == "")
