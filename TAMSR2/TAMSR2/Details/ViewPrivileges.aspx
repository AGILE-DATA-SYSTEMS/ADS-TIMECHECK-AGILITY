<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewPrivileges.aspx.cs" Inherits="TAMSR2.Details.ViewPrivileges" %>



<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <title><%=Resources.Resource.privileges %> - <%=Resources.Resource.applicationName %></title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.privileges %></h4>
                     </div>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls chzn-controls">
                                 <select id="ddPrivilegeGroup" name="prvGroup" style="width: 220px;" class="span6 chosen" data-with-diselect="1" name="org" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.company %>" tabindex="1">
                                    <option value=""></option>
                                 </select>
                              </div>
                           </div>
         ...
         <div class="container-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#"><%=Resources.Resource.privileges %></a></li>					
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.privileges %></div>
                        <div class="tools">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr style="background-color: #e8e3e3;">
                                 ...
                                 <th style="text-align: center;"><%=Resources.Resource.group %></th>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           var oTable = $('#sample_1').dataTable({
               ...
               "aaSorting": [[1, "desc"]],
               "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/SecPrivilegePage.aspx?key=getAll") %>'
           });
       ...
       function LoadPrivilegeGroups() {
           var d = "key=getIdNameListPrvilegeGroupString";
           ...
           $.ajax({
               ...
               success: function (html) {
                   $("#ddPrivilegeGroup").html(html);
                   $("#ddPrivilegeGroup").trigger("liszt:updated");
      ...
      function Clear() {
          ...
          $('#ddPrivilegeGroup option[value=""]').attr('selected', 'selected');
          $("#ddPrivilegeGroup").trigger("liszt:updated");
          //$("#txtCategory").val("");
          //$("#txtService").val("");
      ...
      function Delete() {
           ...
           $.ajax({
               ...
               success: function (html) {
                   if (html != "") {
                       ...
                       $('#ddPrivilegeGroup option[value=' + j.PrivilegeGroupID + ']').attr('selected', 'selected');
                       $("#ddPrivilegeGroup").trigger("liszt:updated");
                   }
               },
               error: function (html) {
       ...
       function Save() {
           ...
           var privilegeGroupID = $("#ddPrivilegeGroup").val();
           if ($('#form_sample_1').validate().form() == false) {
               return false;
           }

           var v = "key=save" + "&id=" + id + "&name=" + name + "&privilegeGroupID=" + privilegeGroupID;
               ...
               init: function () {
                   ...
                   form1.validate({
                       ...
                       errorPlacement: function (error, element) { // render error placement for each input type
                           if (element.attr("name") == "prvGroup") { // for uniform checkboxes, insert the after the given container
