...
{
    public partial class TemplateWizard : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (url.ToLower().Contains("templatewizard.aspx"))
                path = url.Substring(0, url.ToLower().IndexOf("reports/templatewizard.aspx"));
            else
                path = url.Substring(0, url.ToLower().IndexOf("reports/template-wizard"));
