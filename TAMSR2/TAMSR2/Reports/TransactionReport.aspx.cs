...
namespace TAMSR2.Reports
{
    public partial class TransactionReport : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (url.ToLower().Contains("transactionreport.aspx"))
                path = url.Substring(0, url.ToLower().IndexOf("reports/transactionreport.aspx"));
            else
                path = url.Substring(0, url.ToLower().IndexOf("reports/transaction-report"));
