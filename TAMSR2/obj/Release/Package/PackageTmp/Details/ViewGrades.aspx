<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewGrades.aspx.cs" Inherits="TAMSR2.Details.ViewGrades" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <title><%=Resources.Resource.grades %> - <%=Resources.Resource.applicationName %></title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.grades %></h4>
                     </div>
                     <div class="portlet-body form">
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal">
                           ...
                           <div class="control-group" style="display:none;">
                              <label class="control-label"><%=Resources.Resource.noOfCl %><span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" id="txtNoOfCl" name="noOfCl" data-required="1" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group" style="display:none;">
                              <label class="control-label"><%=Resources.Resource.noOfSl %><span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" id="txtNoOfSl" name="noOfSl" data-required="1" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group" style="display:none;">
                              <label class="control-label"><%=Resources.Resource.noOfAl %><span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" id="txtNoOfAl" name="noOfAl" data-required="1" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group">
                               <label class="control-label">&nbsp;</label>
                               <div class="controls">
                                   <input id="chkboxOvertimeEligible" type="checkbox" name="overtimeEligible" /> <%=Resources.Resource.overtimeEligible %>
                                   <input id="chkboxSenior" type="checkbox" name="overtimeEligible" /> <%=Resources.Resource.seniorEmployee %>
                               </div>
                           </div>
         ...
         <div class="container-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#"><%=Resources.Resource.grades %></a></li>					
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.grades %></div>
                        <div class="tools">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr style="background-color: #e8e3e3;">
                                 ...
                                 <th style="text-align: center;"><%=Resources.Resource.overtimeEligible %></th>
                                 <th style="text-align: center;"><%=Resources.Resource.seniorEmployee %></th>
                                 <th style="text-align: center;"><%=Resources.Resource.noOfCl %></th>
                                 <th style="text-align: center;"><%=Resources.Resource.noOfSl %></th>
                                 <th style="text-align: center;"><%=Resources.Resource.noOfAl %></th>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           var oTable = $('#sample_1').dataTable({
               ...
               "aaSorting": [[1, "desc"]],
               "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/GradePage.aspx?key=getAll") %>'
           });
      ...
      function Delete() {
           ...
           $.ajax({
               ...
               success: function (html) {
                   if (html != "") {
                       ...
                       $("#txtCode").val(j.Code);
                       $("#txtNoOfCl").val(j.NoOfCl);
                       $("#txtNoOfSl").val(j.NoOfSl);
                       $("#txtNoOfAl").val(j.NoOfAl);
                       if (j.OvertimeEligible + "" == "Y" || j.OvertimeEligible + "" == "y") {
                           $("#chkboxOvertimeEligible").attr("checked", "checked");
                           $("#uniform-chkboxOvertimeEligible span").addClass("checked");
                       }
                       if (j.SeniorFlag + "" == "Y" || j.SeniorFlag + "" == "y") {
                           $("#chkboxOvertimeEligible").attr("checked", "checked");
                           $("#uniform-chkboxOvertimeEligible span").addClass("checked");
                       }
                   }
       ...
       function Save() {
           ...
           var noOfCl = $("#txtNoOfCl").val();
           var noOfSl = $("#txtNoOfSl").val();
           var noOfAl = $("#txtNoOfAl").val();
           var code = $("#txtCode").val();
           var overtimeEligible = $("#chkboxOvertimeEligible").is(":checked");
           var seniorFlag = $("#chkboxSenior").is(":checked");
           if ($('#form_sample_1').validate().form() == false) {
               return false;
           }
           var v = "key=save" + "&id=" + id + "&code=" + code + "&overtimeEligible=" + overtimeEligible + "&seniorFlag=" + seniorFlag;
           v += "&descriptionEn=" + descriptionEn + "&descriptionAr=" + descriptionAr;
           v += "&noOfCl=" + noOfCl + "&noOfSl=" + noOfSl + "&noOfAl=" + noOfAl;
