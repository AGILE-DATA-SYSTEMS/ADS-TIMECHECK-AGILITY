<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewDeviceGroups.aspx.cs" Inherits="TAMSR2.Details.ViewDeviceGroups" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <title><%=Resources.Resource.deviceGroups %> - <%=Resources.Resource.applicationName %></title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.deviceGroups %></h4>
                     </div>
         ...
         <div class="container-fluid">
			...
			<h3 class="page-title">
									<%=Resources.Resource.deviceGroups %>	
							</h3>
			<ul class="breadcrumb">
				<li>
					<i class="icon-home"></i>
				...
				<li><a href="#"><%=Resources.Resource.deviceGroups %></a></li>					
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.deviceGroups %></div>
                        <div class="tools">
           ...
           return {
               ...
               init: function () {
                   ...
                   form1.validate({
                       ...
                       focusInvalid: false, // do not focus the last invalid input   required: "<%=Resources.Resource.lblRequired %>"
                       ignore: "",
                       rules: {
                           nameEn: {
                               minlength: 3,
