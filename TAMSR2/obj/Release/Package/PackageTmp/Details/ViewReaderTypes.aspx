<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewReaderTypes.aspx.cs" Inherits="TAMSR2.Details.ViewReaderTypes" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <title><%=Resources.Resource.readerTypes %> - <%=Resources.Resource.applicationName %></title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.connectionTypes %></h4>
                     </div>
                     <div class="portlet-body form">
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal">
                           ...
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.driverNameEn %><span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" id="txtDriverNameEn" name="driverNameEn" data-required="1" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.driverNameAr %><span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" id="txtDriverNameAr" name="driverNameAr" data-required="1" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.descriptionEn %></label>
                              <div class="controls">
                                 <input type="text" id="txtDescriptionEn" name="descEn" data-required="1" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.descriptionAr %></label>
                              <div class="controls">
                                 <input type="text" id="txtDescriptionAr" name="descAr" data-required="1" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group">
                               <label class="control-label">&nbsp;</label>
                               <div class="controls">
                                   <input id="chkboxLoadDriverFlag" type="checkbox" name="loadDriver" /> <%=Resources.Resource.loadDriver %>
                               </div>
                           </div>
         ...
         <div class="container-fluid">
			...
			<h3 class="page-title">
									<%=Resources.Resource.readerTypes %>	
							</h3>
			<ul class="breadcrumb">
				<li>
					<i class="icon-home"></i>
				...
				<li><a href="#"><%=Resources.Resource.readerTypes %></a></li>					
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.readerTypes %></div>
                        <div class="tools">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr style="background-color: #e8e3e3;">
                                 ...
                                 <th style="text-align: center;"><%=Resources.Resource.driver %></th>
                                 <th style="text-align: center;"><%=Resources.Resource.loadDriver %></th>
  ...
  <script src='../Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           $("#liReaders").addClass("open");
           $("#liReaderType").addClass("active");
           ...
           var oTable = $('#sample_1').dataTable({
               ...
               "aaSorting": [[1, "desc"]],
               "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/ReaderTypePage.aspx?key=getAll") %>'
           });
           ...
           $.connection.hub.start().done(function () {
               $('#btnBroadCast').click(function () {
                   ...
                   users.server.send('TAMSR2_Reader_Type', '');
       ...
       function Clear() {
           ...
           $("#chkboxLoadDriverFlag").removeAttr("checked");
           $("#uniform-chkboxLoadDriverFlag span").removeClass("checked");
           //$("#txtCategory").val("");
           //$("#txtService").val("");
           ...
           $.ajax({
               ...
               success: function (html) {
                   if (html != "") {
                       ...
                       $("#txtDriverNameEn").val(j.DriverNameEn);
                       $("#txtDriverNameAr").val(j.DriverNameAr);
                       $("#txtDescriptionEn").val(j.DescriptionEn);
                       $("#txtDescriptionAr").val(j.DescriptionAr);
                       if (j.LoadDriverFlag + "" == "1") {
                           $("#chkboxLoadDriverFlag").attr("checked", "checked");
                           $("#uniform-chkboxLoadDriverFlag span").addClass("checked");
                       }
                   }
               },
               error: function (html) {
       ...
       function Save() {
           ...
           var driverEn = $("#txtDriverNameEn").val();
           var driverAr = $("#txtDriverNameAr").val();
           var descriptionEn = $("#txtDescriptionEn").val();
           var descriptionAr = $("#txtDescriptionAr").val();
           var loadDriverFlag = $("#chkboxLoadDriverFlag").is(":checked");
           if ($('#form_sample_1').validate().form() == false) {
               return false;
           }
           var v = "key=save" + "&id=" + id + "&nameEn=" + nameEn + "&nameAr=" + nameAr + "&driverEn=" + driverEn + "&driverAr=" + driverAr;
           v += "&loadDriverFlag=" + loadDriverFlag + "&descriptionEn=" + descriptionEn + "&descriptionAr=" + descriptionAr;
