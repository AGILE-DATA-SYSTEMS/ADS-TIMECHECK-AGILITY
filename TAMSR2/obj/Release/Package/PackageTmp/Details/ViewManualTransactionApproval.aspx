<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewManualTransactionApproval.aspx.cs" Inherits="TAMSR2.Details.ViewManualTransactionApproval" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><%=Resources.Resource.approvemanualtransaction %> - <%=Resources.Resource.applicationName %></title>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    <%=Resources.Resource.approvemanualtransaction %>	
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
   ...
   <![endif]-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#liApproveManualTrans").addClass("active");
   ...
   function LoadEmployees() {
       ...
       function GetLabel() {
        ...
        function LoadGrid(filter) {
           ...
           var urlStr = '<%= Page.ResolveClientUrl("../RequestPages/TAEventPage.aspx?key=GetAllPendingManualMovements") %>' + '&orgID=' + $("#ddOrg").val() + '&groupID=' + $("#ddEmpGroup").val() + '&empID=' + $("#ddEmp").val() + '&fromDate=' + fromDate + '&toDate=' + toDate + '&status=' + status + '&ApproveFlag=' + ApproveFlag
        ...
        function Approve() {
            var v = "key=ApproveRejectManualPunch&";
            $("#divSuccessMsg").css("display", "none");
            $("#divErrorMsg").css("display", "none");
   ...
   function Reject() {
       ...
       if (k == 0) {
           ...
           $.ajax({
               type: 'POST',
               data: v,
               url: '<%= Page.ResolveClientUrl("../RequestPages/TAEventPage.aspx?key=ApproveRejectManualPunch") %>',
               success: function (html) {
                   if (html == "1") {
                       LoadGrid(true);
                       $("#divSuccessMsg").css("display", "block");
