<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AssignUserRoles.aspx.cs" Inherits="TAMSR2.Details.AssignUserRoles" %>



<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <title><%=Resources.Resource.assignRoles %> - <%=Resources.Resource.applicationName %></title>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    <%=Resources.Resource.assignRoles %>	
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                    ...
                    <li>
                        <a href="<%= Page.ResolveClientUrl("~/Emp/Employee-Groups") %>"><%=Resources.Resource.roles %></a>
                        <i class="icon-angle-right"></i>
                    </li>
                    <li><a href="#"><%=Resources.Resource.assignRoles %></a></li>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="portlet box light-grey">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i> <%= roleName %> - <%=Resources.Resource.groupMembers %></div>
                        <div class="tools">
  ...
  <script src='<%= path %>Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           $("#ddOrg").change(function () {
               var oTable = $('#sample_Employees').dataTable({
                   ...
                   "aaSorting": [[1, "desc"]],
                   "sAjaxSource": '<%= Page.ResolveClientUrl("~/RequestPages/AssignUserRolePage.aspx?key=getAllEmployeesByOrgIDGroupID&orgID=" ) %>' + $("#ddOrg").val() + '&groupID=<%= roleID %>'
               });
           });
       ...
       function LoadMemberGrid(filter) {
           var url = '<%= Page.ResolveClientUrl("~/RequestPages/AssignUserRolePage.aspx?key=getAllMembersByOrgIDGroupID&orgID=" ) %>' + $("#ddOrg").val() + '&groupID=<%= roleID %>';
       ...
       function LoadEmployeeGrid(filter) {
           var url = '<%= Page.ResolveClientUrl("~/RequestPages/AssignUserRolePage.aspx?key=getAllEmployeesByOrgIDGroupID&orgID=" ) %>' + $("#ddOrg").val() + '&groupID=<%= roleID %>';
           var filterValue = "";
           if (filter == true) {
       ...
       function SaveGroupMembers() {
           var v = "key=assignGroupMembers&groupID=<%= roleID %>&";
           ...
           $.ajax({
               type: 'POST',
               data: v,
               url: '<%= Page.ResolveClientUrl("~/RequestPages/AssignUserRolePage.aspx") %>',
               success: function (html) {
                   if (html == "1") {
           ...
           function Delete() {
               var v = "key=removeGroupMembers&groupID=<%= roleID %>&";
