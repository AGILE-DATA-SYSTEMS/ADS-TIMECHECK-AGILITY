...
namespace TAMSR2.CrystalReports {
    ...
    public class Arabic_Movement_Report : ReportClass {
        
        public Arabic_Movement_Report() {
        }
        
        public override string ResourceName {
            get {
                return "Arabic_Movement_Report.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TAMSR2.CrystalReports.Arabic_Movement_Report.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedArabic_Movement_Report : Component, ICachedReport {
        
        public CachedArabic_Movement_Report() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Arabic_Movement_Report rpt = new Arabic_Movement_Report();
            rpt.Site = this.Site;
            return rpt;
        }
