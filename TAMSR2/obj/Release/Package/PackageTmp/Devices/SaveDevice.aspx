                                ...
                                <div class="span4">
                                    <div class="control-group">
                                        <div class="controls">
                                            ...
                                            <button type="button" class="btn btn-outline-primary btn-md pull-right" id="btnUpdateDeviceTime">
                                                <i class="btn-primary"></i><%=Resources.Resource.set %> <%=Resources.Resource.device %> <%=Resources.Resource.time %>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div class="span3">
                                    <button type="button" class="btn btn-outline-primary btn-md pull-right" id="btnRestartDevice" style="width: 100%">
                                        <i class="btn-primary"></i><%=Resources.Resource.restart %>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span3 ">
                                        <div class="control-group">
                                            ...
                                            <label><%=Resources.Resource.resolution %></label>
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span3">
                                            <div class="control-group pull-right">
                                                <div class="controls" style="float: left; margin-left: 0px;">
                                                    <button type="button" class="btn btn-outline-primary btn-md pull-right" id="btnEnroll">
   ...
   <![endif]-->
    ...
    <script type="text/javascript">
        ...
        function EditDevice(deviceId) {
            ...
            var v = "key=getDeviceByID&id=" + deviceId;
                ...
                success: function (html) {
                    if (html != "") {
                        ...
                        $(j.aaData).each(function (i, key) {
                            $('#txt' + $(key)[0].split('_')[0]).val($(key)[0].split('_')[1]);
                        });
...
<%--        function LoadGrid() {
        ...
        $('#btnShutdownDevice').click(function () {
            var url = baseUrl + "/api/Device/" + glbDeviceId + "/PowerOff";
            //var data = "{'ID':" + DeviceId + "}";
            $.ajax({
                type: "PUT",
                url: url,
        ...
        $('#btnUpdateDeviceTime').click(function () {
            ...
            var minute = $('#txtInTime1').val().split(':')[1].split(' ')[0];
            var hour = $('#txtInTime1').val().split(':')[0];
            var dateTime = month + " " + day + " " + hour + " " + minute + " " + year + ".0";
            //var data = "{'ID':" + DeviceId + ",'dateTime':" + dateTime + "'}";
            var url = baseUrl + "/api/Device/" + glbDeviceId + "/" + dateTime;
            $.ajax({
                type: "PUT",
                url: url,
                //data: data,
        ...
        $('#btnFunctionApply').click(function () {
            ...
            for (var i = 1; i <= 5; i++) {
                var url = '<%= Page.ResolveClientUrl("~/RequestPages/ReaderPage.aspx") %>';
                KeyLabel = $('#txtF' + i).val();
                d = "key=saveDeviceFunctions" + "&DeviceId=" + glbDeviceId + "&FunctionKeyLabel=F" + i + "&FunctionKeyValue=" + KeyLabel + "&DevicefunctionIdNotIn=" + DeviceFunctionId;
                $.ajax({
                    type: "GET",
                    url: url,
                    data: d,
                ...
                if (KeyLabel != "") {
                    var apiUrl = baseUrl + "/api/Device/" + (i - 1) + "/" + KeyLabel;
                    $.ajax({
                        type: "PUT",
                        url: apiUrl,
                        //data: data,
...
<%--                            var url = '<%= Page.ResolveClientUrl("~/RequestPages/ReaderPage.aspx") %>';
        ...
        $('#btnApply').click(function () {
            ...
            var APIUrl = baseUrl + "/api/Device/" + glbDeviceId + "/UserMessage/001";
            var data = "{'UserMessage':" + Msg + "}";
        ...
        $('#btnSyncEnroll').click(function () {
            var url = baseUrl + "/api/Device/" + glbDeviceId + "/SyncEnrollment";
            $.ajax({
                type: "PUT",
                url: url,
                //data: data,
