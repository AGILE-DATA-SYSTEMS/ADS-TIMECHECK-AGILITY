<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewReaders.aspx.cs" Inherits="TAMSR2.Devices.ViewReaders" %>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box purple tabbable">
                        <div class="portlet-title">
                            <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.readers %></h4>
                        </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class=" tabbable portlet-tabs">
                                <ul class="nav nav-tabs">
                                    <li id="settings" style="display: none;"><a href="#portlet_tab3" data-toggle="tab"><%=Resources.Resource.settings %></a></li>
                                    <li id="action" style="display: none;"><a href="#portlet_tab2" data-toggle="tab"><%=Resources.Resource.action %></a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="portlet_tab1">
                                    <form action="#" id="form_sample_1" class="form-horizontal" style="height: 450px !important;">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" disabled id="txtCode" name="code" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input disabled type="text" id="txtName" name="nameEn" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row-fluid" style="display: none !important;">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select disabled id="ddDeviceGroup" style="width: 220px;" name="deviceGroup" class="span6 chosen" data-with-diselect="1" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.deviceGroup %>">
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%=Resources.Resource.connectionType %><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <select disabled id="ddConnection" style="width: 220px;" name="connectionType" class="span6 chosen" data-with-diselect="1" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.connectionType %>">
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input disabled type="text" id="txtIPAddress" name="ipAddress" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%=Resources.Resource.port %><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <input disabled type="text" id="txtPort" name="port" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%=Resources.Resource.baudRate %></label>
                                                    <div class="controls">
                                                        <input disabled type="text" id="txtBaudRate" name="baudRate" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%=Resources.Resource.location %></label>
                                                    <div class="controls">
                                                        <input type="text" id="txtLocation" name="location" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <div class="row-fluid">
                                                <div class="span6">
                                                    <div class="control-group">
                                                        <label class="control-label"><%=Resources.Resource.choose %> <%=Resources.Resource.building %><span class="required">*</span></label>
                                                        <div class="controls">
                                                            <select id="ddBuildingsList" style="width: 220px;" name="BuildingsList" class="span6 chosen" data-with-diselect="1" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.building %>" tabindex="6">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <%--  <div class="span6 ">
                                        <div class="control-group">
                                            <label class="control-label"><%=Resources.Resource.connectionTimeOut %></label>
                                            <div class="controls">
                                                <input disabled type="text" id="txtTimeOut" name="timeout" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                            </div>
                                        </div>
                                    </div>--%>
                                            <!--/span-->
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select id="ddReaderDirection" style="width: 220px;" name="direction" class="span6 chosen" data-with-diselect="1" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.direction %>">
                                                    <option value="2"><%=Resources.Resource.bidirectional %> </option>
                                    ...
                                    <div class="span6 ">
                                        <div class="control-group">
                                            <label class="control-label"><%=Resources.Resource.location %><span class="required">*</span></label>
                                            <div class="controls">
                                                <select id="ddLocation" style="width: 220px;" name="location" class="span6 chosen" data-with-diselect="1" data-placeholder="<%=Resources.Resource.choose %> <%=Resources.Resource.location %>">
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="span6 ">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%=Resources.Resource.map %></label>
                                                    <div class="controls">
                                                        <div id="map" style="position: absolute !important; width: 70% !important; min-height: 50% !important; height: 50% !important;"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane  " id="portlet_tab2">
                                    <form action="#" id="form1" class="form-horizontal">
                                        <div id="divError2" class="alert alert-error hide">
                                            <button class="close" data-dismiss="alert"></button>
                                            <span id="spnError2"><%=Resources.Resource.formErrors %></span>
                                        </div>
                                        <div id="divSuccess2" class="alert alert-success hide">
                                            <button class="close" data-dismiss="alert"></button>
                                            <span id="spnSuccess2"><%=Resources.Resource.formErrorsRemoved %></span>
                                        </div>


                                        <table class="table table-striped table-bordered   dataTable" style="width: 98%; margin: auto;">
                                            <thead>
                                                <tr>
                                                    <th style="width: 5%;"><%=Resources.Resource.no %></th>
                                                    <th style="width: 20%;"><%=Resources.Resource.action %></th>
                                                    <th style="width: 20%;"><%=Resources.Resource.action %> Type</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td style="align-content: center; width: 20% !important; margin: auto;">
                                                        <button id="btnDBReload" type="button" style="align-content: center; width: 98% !important; margin: auto;" class="btn blue"><i class="icon-spinner">&nbsp;<%-- <%=Resources.Resource.dbreload %>--%></i></button>
                                                    </td>
                                                    <td>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="rdoDBSoft">
                                                                <span>
                                                                    <input type="radio" checked value="0" name="DBRELOAD" style="opacity: 0;"></span>
                                                            </div>
                                                            <%--   <%=Resources.Resource.soft %>--%>
                                                        </label>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="rdoDBHard">
                                                                <span>
                                                                    <input type="radio" value="1" name="DBRELOAD" style="opacity: 0;"></span>
                                                            </div>
                                                            <%--  <%=Resources.Resource.hard %>--%>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <%--<%=Resources.Resource.msgDBReload %>--%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td style="align-content: center; width: 20% !important; margin: auto;">
                                                        <button id="btnFirmware" type="button" style="align-content: center; width: 98% !important; margin: auto;" class="btn purple"><i class="icon-adjust">&nbsp;<%--<%=Resources.Resource.firmware %>--%> </i></button>
                                                    </td>
                                                    <td>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="rdoFirmwareSoft">
                                                                <span>
                                                                    <input type="radio" checked value="0" name="FIRMWARE" style="opacity: 0;"></span>
                                                            </div>
                                                            <%-- <%=Resources.Resource.soft %>--%>
                                                        </label>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="rdoFirmwareHard">
                                                                <span>
                                                                    <input type="radio" value="1" name="FIRMWARE" style="opacity: 0;"></span>
                                                            </div>
                                                            <%-- <%=Resources.Resource.hard %>--%>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <%--<%=Resources.Resource.firmware %>--%>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>3</td>
                                                    <td style="align-content: center; width: 20% !important; margin: auto;">
                                                        <button id="btnRestart" type="button" style="align-content: center; width: 98% !important; margin: auto;" class="btn green"><i class="icon-refresh">&nbsp;<%--<%=Resources.Resource.restartdevice %>--%> </i></button>
                                                    </td>
                                                    <td>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="rdoRestartSoft">
                                                                <span>
                                                                    <input type="radio" checked value="0" name="RESTART" style="opacity: 0;"></span>
                                                            </div>
                                                            <%-- <%=Resources.Resource.soft %>--%>
                                                        </label>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="rdoRestartHard">
                                                                <span>
                                                                    <input type="radio" value="1" name="RESTART" style="opacity: 0;"></span>
                                                            </div>
                                                            <%-- <%=Resources.Resource.hard %>--%>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <%--  <%=Resources.Resource.msgRestartDevice %>--%>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>4</td>
                                                    <td style="align-content: center; width: 20% !important; margin: auto;">
                                                        <button id="btnUpdateDeviceSetting" type="button" style="align-content: center; width: 98% !important; margin: auto;" class="btn prple"><i class="icon-cogs">&nbsp<%--;<%=Resources.Resource.updatedevicesttings %> --%> </i></button>
                                                    </td>
                                                    <td>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="rdoDeviceSettingsSoft">
                                                                <span>
                                                                    <input type="radio" checked value="0" name="SETUP" style="opacity: 0;"></span>
                                                            </div>
                                                            <%-- <%=Resources.Resource.soft %>--%>
                                                        </label>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="rdoDeviceSettingsHard">
                                                                <span>
                                                                    <input type="radio" value="1" name="SETUP" style="opacity: 0;"></span>
                                                            </div>
                                                            <%--  <%=Resources.Resource.hard %>--%>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <%--  <%=Resources.Resource.msgUpdateDeviceSettings %>--%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>5</td>
                                                    <td style="align-content: center; width: 20% !important; margin: auto;">
                                                        <button id="btnRestoreFS" type="button" style="align-content: center; width: 98% !important; margin: auto;" class="btn black"><i class="icon-wrench">&nbsp;<%--<%=Resources.Resource.restorefactorysettings %>--%></i>  </button>
                                                    </td>
                                                    <td>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="RestoreFSSoft">
                                                                <span>
                                                                    <input type="radio" checked value="0" name="INITIALIZE" style="opacity: 0;"></span>
                                                            </div>
                                                            <%-- <%=Resources.Resource.soft %>--%>
                                                        </label>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="RestoreFSHard">
                                                                <span>
                                                                    <input type="radio" value="1" name="INITIALIZE" style="opacity: 0;"></span>
                                                            </div>
                                                            <%--<%=Resources.Resource.hard %>--%>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <%--  <%=Resources.Resource.msgrestoretoFS %>--%>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>6</td>
                                                    <td style="align-content: center; width: 20% !important; margin: auto;">
                                                        <button id="btnStats" type="button" style="align-content: center; width: 98% !important; margin: auto;" class="btn red"><i class="icon-bolt">&nbsp;<%=Resources.Resource.statistics %> </i></button>
                                                    </td>
                                                    <td>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="rdoStatsSoft">
                                                                <span>
                                                                    <input type="radio" checked value="0" name="STATS" style="opacity: 0;"></span>
                                                            </div>
                                                            <%--  <%=Resources.Resource.soft %>--%>
                                                        </label>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="rdoStatsHard">
                                                                <span>
                                                                    <input type="radio" value="1" name="STATS" style="opacity: 0;"></span>
                                                            </div>
                                                            <%-- <%=Resources.Resource.hard %>--%>
                                                        </label>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>6</td>
                                                    <td style="align-content: center; width: 20% !important; margin: auto;">
                                                        <button id="btnUpdateLogo" type="button" style="align-content: center; width: 98% !important; margin: auto;" class="btn purple"><i class="icon-bolt">&nbsp;<%=Resources.Resource.logo %> </i></button>
                                                    </td>
                                                    <td>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="softLogo">
                                                                <span>
                                                                    <input type="radio" checked value="0" name="LOGO" style="opacity: 0;"></span>
                                                            </div>
                                                            <%--   <%=Resources.Resource.soft %>--%>
                                                        </label>
                                                        <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                            <div class="radio" id="HardLogo">
                                                                <span>
                                                                    <input type="radio" value="1" name="LOGO" style="opacity: 0;"></span>
                                                            </div>
                                                            <%-- <%=Resources.Resource.hard %>--%>
                                                        </label>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <%-- <%=Resources.Resource.msgupdatelogo %> --%>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="tab-pane  " id="portlet_tab3">
                                    <form action="#" id="form2" class="form-horizontal">
                                        <div id="divError3" class="alert alert-error hide">
                                            <button class="close" data-dismiss="alert"></button>
                                            <span id="spanError3"><%=Resources.Resource.formErrors %></span>
                                        </div>
                                        <div id="divSuccess3" class="alert alert-success hide">
                                            <button class="close" data-dismiss="alert"></button>
                                            <span id="spanSuccess3"><%=Resources.Resource.formErrorsRemoved %></span>
                                        </div>

                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.sound %>--%><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <%--<%=Resources.Resource.deviceType %>--%>
                                                        <select id="selSound" style="width: 220px;" name="ddSound" class="span6 chosen" data-with-diselect="1" data-placeholder="<%=Resources.Resource.choose %> ">
                                            ...
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.display %>--%><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <%--<%=Resources.Resource.deviceType %>--%>
                                                        <select id="selDisplay" style="width: 220px;" name="ddDisplay" class="span6 chosen" data-with-diselect="1" data-placeholder="<%=Resources.Resource.choose %> ">
                                                            <option value="0">00</option>
                                                            <option value="1">01</option>
                                                            <option value="2">02</option>
                                                            <option value="3">03</option>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.screenTimeOut %>--%><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <%--<%=Resources.Resource.deviceType %>--%>
                                                        <select id="selscreenTimeOut" style="width: 220px;" name="ddScreenTimeout" class="span6 chosen" data-with-diselect="1" data-placeholder="<%=Resources.Resource.choose %> ">
                                                            <option value="30">30</option>
                                                            <option value="60">60</option>
                                                            <option value="90">90</option>
                                            ...
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.messageTimeOut %>--%><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <%--<%=Resources.Resource.deviceType %>--%>
                                                        <select id="selMsgTimeOut" style="width: 220px;" name="ddMsgTimeout" class="span6 chosen" data-with-diselect="1" data-placeholder="<%=Resources.Resource.choose %> ">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" name="file_upload" id="logo" class="default" accept="image/*" />
                                                    </div>
                                                    <div class="controls">
                                            ...
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.screen1 %>--%></label>
                                                    <div class="controls">
                                                        <input type="file" name="file_upload" id="screen1" accept="image/*" class="default" />
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.screen2 %>--%></label>
                                                    <div class="controls">
                                                        <input type="file" name="file_upload" id="screen2" class="default" accept="image/*" />
                                                    </div>
                                                    <div class="controls">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.screen3 %>--%></label>
                                                    <div class="controls">
                                                        <input type="file" name="file_upload" id="screen3" class="default" accept="image/*" />
                                                    </div>
                                                    <div class="controls">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.screen4 %>--%></label>
                                                    <div class="controls">
                                                        <input type="file" name="file_upload" id="screen4" class="default" accept="image/*" />
                                                    </div>
                                                    <div class="controls">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.screen5 %>--%></label>
                                                    <div class="controls">
                                                        <input type="file" name="file_upload" id="screen5" class="default" accept="image/*" />
                                                    </div>
                                                    <div class="controls">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.serverAddress %>--%><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <input type="text" id="txtServerAddress" name="serverAddress" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.firmware %>--%><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <input type="text" id="firmware" name="code" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.button1 %>--%><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <input type="text" id="txtButton1" name="button1" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.button2 %>--%><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <input type="text" id="txtButton2" name="button2" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.button3 %>--%><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <input type="text" id="txtButton3" name="button3" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label"><%--<%=Resources.Resource.button4 %>--%><span class="required">*</span></label>
                                                    <div class="controls">
                                                        <input type="text" id="txtButton4" name="button4" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                    ...
                                    <div class="span6 ">
                                         <div class="control-group">
                                            <label class="control-label"><%=Resources.Resource.button5 %><span class="required">*</span></label>
                                            <div class="controls">
                                                <input type="text" id="txtButton5" name="button5" style="width: 220px !important;" data-required="1" class="span6 m-wrap" />
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    ...
                                    <!--/span-->
                                        ...
                                        <!--/row-->
                                        <div class="row-fluid">
                                            <div class="span6 " style="width: 52% !important;">
                                                <div class="control-group">
                                                    <label class="control-label">&nbsp;</label>
                                                    <div class="controls">
                                                        <input id="chkAddUser" type="checkbox" name="adduser" />
                                                        <%-- <%=Resources.Resource.enableAddUser %>--%>
                                                    </div>
                                                    <div class="controls">
                                                        <input id="chkUpdateUser" type="checkbox" name="updatesuser" />
                                                        <%--<%=Resources.Resource.enableUpdateUser %>--%>
                                                    </div>
                                                    <div class="controls">
                                                        <input id="chkDeleteUser" type="checkbox" name="deleteuser" />
                                                        <%--<%=Resources.Resource.enableDeleteUser %>--%>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <div class="control-group">
                                                <label class="control-label"><%--<%=Resources.Resource.authenticationType %>--%></label>
                                                <div class="controls">
                                                    <label class="radio  " style="margin: 10px; padding-left: 10px !important;">
                                                        <div class="radio" id="uniform-Device">
                                                            <span class="checked">
                                                                <input type="radio" checked value="0" name="authentication" style="opacity: 0;"></span>
                                                        </div>
                                                        <%--  <%=Resources.Resource.device %>--%>
                                                    </label>
                                                    <label class="radio  " style="margin: 10px;">
                                                        <div class="radio" id="uniform-User">
                                                            <span class="">
                                                                <input type="radio" value="1" name="authentication" style="opacity: 0;"></span>
                                                        </div>
                                                        <%-- <%=Resources.Resource.user %>--%>
                                                    </label>
                                                    <label class="radio" style="margin: 10px;">
                                                        <div class="radio" id="uniform-Mixed">
                                                            <span class="">
                                                                <input type="radio" value="2" name="authentication" style="opacity: 0; display: none;"></span>
                                                        </div>
                                                        <%-- <%=Resources.Resource.mixed %>--%>
                                                    </label>
                                                </div>
                                            </div>
                                            <!--/span-->
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button id="btnSavenApply" type="button" onclick="SaveSettings(1);" class="btn green"><%--<%=Resources.Resource.savenapply %>--%></button>
                                        <button id="btnSaveSettings" type="button" onclick="SaveSettings(0)" class="btn purple"><%=Resources.Resource.save %></button>
                                        <button type="button" onclick="return CloseForm()" data-dismiss="modal" class="btn"><%=Resources.Resource.cancel %></button>
                        ...
                        <div class="clearfix">
                            ...
                            <div class="btn-group pull-<%= pullDirectionStr %>" style="">
                                <span id="spnAddButton" runat="server">
                                    <a id="btnAdd" onclick="return Clear()" href="#portlet-config" class="btn green"><i class="icon-plus">&nbsp; <%=Resources.Resource.add %></i></a>
                                </span>
                                <span id="spnDeleteButton" runat="server">
                                    <a id="btnDelete" onclick="return DeleteDevice()" style='margin: 0px 10px;' class="btn red"><i class="icon-trash">&nbsp; <%=Resources.Resource.delete %></i></a>
                                </span>
                            </div>
                        </div>
   ...
   <![endif]-->
    ...
    <script type="text/javascript">
        ...
        function LoadGrid() {
            ...
            var url = '<%= Page.ResolveClientUrl("~/RequestPages/ReaderPage.aspx?key=GetDeviceData")%>' + '&DeviceType=' + deviceType + '&status=' + deviceStatus;
            //alert(url);
            ...
            var oTable = $('#sample_1').dataTable({
                ...
                "aoColumns": [
                    ...
                    //{ "bSortable": true, sWidth: "5%" },
                    { "bSortable": false, sWidth: "11.25%" },
                    { "bSortable": true, sWidth: "11.25%" },
                    { "bSortable": true, sWidth: "11.25%" },
                    //{ "bSortable": true, sWidth: "20%" },
                    { "bSortable": true, sWidth: "11.25%" },
                    { "bSortable": true, sWidth: "11.25%" },
        ...
        $("#btnAdd").click(function () {
            window.location.href = window.location.protocol + "//" + window.location.host + "/Devices/savedevice.aspx";
        });
        ...
        function EditDevice(Id) {
            window.location.href = window.location.protocol + "//" + window.location.host + "/Devices/savedevice.aspx?DeviceId=" + Id;
        }
