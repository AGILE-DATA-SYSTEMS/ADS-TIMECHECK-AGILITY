<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewWorkflows.aspx.cs" Inherits="TAMSR2.Workflows.ViewWorkflows" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.workflow %></h4>
                     </div>
         ...
         <div class="container-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#"><%=Resources.Resource.workflow %></a></li>					
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.workflow %></div>
                        <div class="tools">
                        ...
                        <div class="clearfix">
                           ...
                           <div class="btn-group pull-<%= pullDirectionStr %>" style="">
                              <span id="spnAddButton" runat="server" >
                                  <a id="btnAdd" onclick="return AddWorkflow()" href="javascript:void(0);" data-toggle="modal" class="btn green"><i class="icon-plus"> &nbsp; <%=Resources.Resource.add %></i></a> 
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr style="background-color: #e8e3e3;">
                                 ...
                                 <th style="text-align: center;"><%=Resources.Resource.category %></th> 
                                 <th style="text-align: center;"><%=Resources.Resource.steps %></th> 
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           var oTable = $('#sample_1').dataTable({
               ...
               "aaSorting": [[1, "desc"]],
               "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/WorkflowPage.aspx?key=getAll") %>'
           });
           ...
           $.connection.hub.start().done(function () {
               $('#btnBroadCast').click(function () {
                   ...
                   users.server.send('TAMSR2_Wrokflow', '');
       ...
       function AddWorkflow() {
           ...
           var urlStr = '<%= Page.ResolveClientUrl("~/Workflows/Save-Workflow") %>';
       ...
       */
       function Save() {
           ...
           v += "&descriptionEn=" + descriptionEn + "&descriptionAr=" + descriptionAr + "&official=" + official + "&allowAttachement=" + allowAttachement;
