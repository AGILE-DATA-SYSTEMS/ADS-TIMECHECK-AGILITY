<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApplyScheduleRoster.aspx.cs" Inherits="TAMSR2.ScheduleMonthlyRoster.ApplyScheduleRoster" %>



<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title><%=Resources.Resource.applyScheduleRoster %> - <%=Resources.Resource.applicationName %></title>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    <%=Resources.Resource.applyScheduleRoster %> 
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                    ...
                    <li><a href="#"><%=Resources.Resource.applyScheduleRoster %></a></li>
                        ...
                        <div style="width: 100%; overflow: scroll; overflow-y: hidden; padding: 0px 0px;">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                              ...
                              <tr style="background-color: #e8e3e3;">
                                        ...
                                        <th style="text-align: center;width: 44px !important;"><%=Resources.Resource.status %></th>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="btn-group pull-<%= pullDirectionStr %>" style="">
                            <span id="spnAddButton" runat="server">
                                ...
                                <a id="btnFinlaize" onclick="return Finalize()" style='display: none; margin: 0px 5px;' class="btn green"><i class="icon-plus">&nbsp; <%=Resources.Resource.finalize %></i></a>
   ...
   <![endif]-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#liApplySchRoster").addClass("active");
        ...
        function LoadOrganizations() {
           ...
           function LoadEmployees() {
               ...
               success: function (html) {
                   $("#form_sample_1").unmask();
                   $("#ddEmp").html(html);
                   $('#ddEmp option[value=<%= Session["ID"] %>]').attr('selected', 'selected');
       ...
       function LoadSchedules() {
           ...
           function Save() {
               ...
               $("#sample_1 tbody tr").each(function () {
                   var rowEid = ($(this).attr("eid") + "").trim();
                   if (rowEid + "" != "" && rowEid + "" != "undefined") {
                       var rowDay = "";
                       var rowSch = "";
