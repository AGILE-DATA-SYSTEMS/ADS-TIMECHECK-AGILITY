<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewAppliedEmployeeSchedules.aspx.cs" Inherits="TAMSR2.EmployeeScheduleWorkFlow.ViewAppliedEmployeeSchedules" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <title><%=Resources.Resource.appliedSchedules %> - <%=Resources.Resource.applicationName %></title>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    <%=Resources.Resource.appliedSchedules %> 
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                    ...
                    <li><a href="#"><%=Resources.Resource.appliedSchedules %></a></li>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="portlet box light-grey">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.appliedSchedules %></div>
                        <div class="tools">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="btn-group pull-<%= pullDirectionStr %>" style="">
                                <span id="spnAddButton" runat="server">
                                    <a id="btnApplySch" href="../Sch/Apply-Employee-Schedules/<%= TAMSR2.CustomClasses.Encryption.Encrypt("0") %>" class="btn green"><i class="icon-plus">&nbsp; <%=Resources.Resource.applySchedule %></i></a>
                                </span>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            users.client.broadcastMessage = function (name, message) {
                if (name == "TAMSR2_Schedules_Applied") {
                    LoadGrid();
                }
            };
        ...
        function LoadGrid() {
            var urlStr = '<%= Page.ResolveClientUrl("../RequestPages/EmployeeScheduleManualPage.aspx?key=getAll") %>'; // + '&orgID=' + $("#ddOrg").val() + '&groupID=' + $("#ddEmpGroup").val() + '&empID=' + $("#ddEmp").val();
