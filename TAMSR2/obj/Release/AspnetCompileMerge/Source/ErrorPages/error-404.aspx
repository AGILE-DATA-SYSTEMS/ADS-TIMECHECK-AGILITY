<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="error-404.aspx.cs" Inherits="TAMSR2.ErrorPages.error_404" %>



<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
  <title><%=Resources.Resource.error404 %> - <%=Resources.Resource.applicationName %></title>
                  ...
                  <div class="row-fluid page-404">
                     ...
                     <div class="span7 details">
                        ...
                        <p>
                           ...
                           Please check that you typed correct spellings or <br />contact administrator about correct URL.
                        </p>
                     </div>
                  </div>
               </div>
