<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewMonthlyRosterView.aspx.cs" Inherits="TAMSR2.Reports.ViewMonthlyRosterView" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <title><%=Resources.Resource.rosterView %> - <%=Resources.Resource.applicationName %></title>
      ...
      <div class="page-container row-fluid">
        ...
        <div class="page">
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h3 class="page-title"><%= Resources.Resource.rosterView %>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                            ...
                            <li><a href="#"><%= Resources.Resource.rosterView %></a></li>
                        </ul>
                    </div>
                </div>
                <!-- END PAGE HEADER-->
                    ...
                    <div class="span12">
                        <div class="portlet box blue" id="form_wizard_1">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-reorder"></i><%= Resources.Resource.rosterView %> <span class="step-title" id="step"></span>
                                </div>
                            ...
                            <div class="portlet-body form">
                                 <form action="#" id="form_1" class="form-horizontal">
                                        ...
                                        --%>
                                         ...
                                         <div class="row-fluid">
                                            <div class="span12">
                                                <h3 class="block"><%=Resources.Resource.rosterView %></h3>
                                                  <div class="row-fluid">
                                                    <div class="span6 ">
    ...
    <script type="text/javascript">
        ...
        $('#btnWordDownload').click(function () {
            ...
            function ShowReport(action)
            {
                ...
                var d = "key=ShowRosterView&Org="+Org+"&Year="+Year+"&Month="+Month+"&EmpID="+EmpID+"&MgrId="+ MgrId  +"&EmpName="+EmpName+"&OrgName="+OrgName;
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        ...
                        if (action == 'ViewReport') {
                            window.open('../Reports/ViewRptRosterView.aspx?Key=viewreport', '_blank', 'toolbar=0,scrollbars=1,location=0,menubar=0,resizable=yes');
                        }
                        else if (action == 'ExcelDownload')
                        {
                            window.location.href = '../Reports/ViewRptRosterView.aspx?Key=Excel';

                        }
                        else if (action == 'WordDownload')
                        {
                            window.location.href = '../Reports/ViewRptRosterView.aspx?Key=Word';

                        }
                        else if (action == 'PdfDownload') {
                            window.location.href = '../Reports/ViewRptRosterView.aspx?Key=Pdf';
