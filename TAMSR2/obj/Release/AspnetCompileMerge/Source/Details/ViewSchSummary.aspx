<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewSchSummary.aspx.cs" Inherits="TAMSR2.Details.ViewSchSummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <title><%=Resources.Resource.schedules %> - <%=Resources.Resource.applicationName %></title> <link href="assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title" style="margin: 0px;"><%=Resources.Resource.schedules %> 					<small style="display: none;">statistics and more</small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                            ...
                            <%   if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_SCHEDULE_TYPES) == true)
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number transactions"  data-percent="33"><span>3</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Sch/Schedule-Types") %>'> &nbsp;<%= Resources.Resource.scheduleTypes %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number visits"  data-percent="33"><span>3</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Sch/Schedule-Locations") %>'>  &nbsp; <%= Resources.Resource.scheduleLocations %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number bounce"  data-percent="33"><span>3</span></div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Sch/Schedule-Time") %>'> &nbsp; <%= Resources.Resource.scheduleTime %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                                 </div>
                              <div class="row-fluid">
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number transactions"  data-percent="33"><span>3</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Sch/Schedules") %>'> &nbsp;<%= Resources.Resource.schedules %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number visits"  data-percent="33"><span>3</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Sch/Monthly-Roster") %>'> &nbsp;<%= Resources.Resource.roster %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                                 <% }  if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_SCHEDULE_ROSTER) == true)
                                 { %>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number bounce"  data-percent="33"><span>3</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Sch/My-Schedule-Roster-View") %>'> &nbsp;<%= Resources.Resource.monthlyRoster %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                               <% } %>
                           </div>
