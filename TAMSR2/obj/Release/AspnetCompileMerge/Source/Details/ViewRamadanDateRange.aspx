<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewRamadanDateRange.aspx.cs" Inherits="TAMSR2.Details.ViewRamadanDateRange" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title><%=Resources.Resource.ramadanDateRanges %> - <%=Resources.Resource.applicationName %></title>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.ramadanDateRanges %></h4>
                        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    <%=Resources.Resource.ramadanDateRanges %>	
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                    ...
                    <li><a href="#"><%=Resources.Resource.ramadanDateRanges %></a></li>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="portlet box light-grey">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.ramadanDateRanges %></div>
                        <div class="tools">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="btn-group pull-<%= pullDirectionStr %>" style="">
                                <span id="spnAddButton" runat="server">
                                    <a id="btnAdd" onclick="return Clear()" href='<%= Page.ResolveClientUrl("~/Sch/Save-Ramadan-Date-Range/" + TAMSR2.CustomClasses.Encryption.Encrypt("0")) %>' class="btn green"><i class="icon-plus">&nbsp; <%=Resources.Resource.add %></i></a>
                                </span>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            <thead>
                              <tr style="background-color: #e8e3e3;">
                                    ...
                                    <th style="text-align: center; display: none;"><%=Resources.Resource.recurring %></th>
   ...
   <![endif]-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#liSchRamadanDateRange").addClass("active");
            ...
            var oTable = $('#sample_1').dataTable({
                ...
                "aaSorting": [[1, "desc"]],
                "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/RamadanDateRangePage.aspx?key=getAll") %>'
            });
        ...
        function Delete() {
           ...
           if (confirm("<%=Resources.Resource.deleteMessage %>")) {
               $.ajax({
                   type: 'POST',
                   data: v,
                   url: '<%= Page.ResolveClientUrl("../RequestPages/RamadanDateRangePage.aspx") %>',
