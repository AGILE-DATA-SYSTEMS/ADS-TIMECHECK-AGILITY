<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SaveHoliday.aspx.cs" Inherits="TAMSR2.Details.SaveHoliday" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href='<%= Page.ResolveClientUrl("~/Common/Holidays") %>'><%=Resources.Resource.holidays %></a></li>
                        ...
                        <div class="span6 ">
                            <div class="control-group">
                             ...
                             <div class="control-group">
                                <label class="control-label">&nbsp;</label>
                                <div class="controls">
                                    <input id="chkBoxPublicHoliday" type="checkbox" name="ph" />
                                    <%=Resources.Resource.publicHoliday %>
                                </div>
                            </div>
                        </div>
                        <!--/span-->
   ...
   <![endif]-->
    ...
    <script type="text/javascript">
        ...
        function Clear() {
            ...
            $("#chkBoxPublicHoliday").removeAttr("checked");
            $("#uniform-chkBoxPublicHoliday span").removeClass("checked");
            ...
            $.ajax({
               ...
               success: function (html) {
                   if (html != "") {
                       ...
                       if (j.PublicHolidayFlag + "" == "1") {
                           $("#chkBoxPublicHoliday").attr("checked", "checked");
                           $("#uniform-chkBoxPublicHoliday span").addClass("checked");
                       }
                   }
               },
               error: function (html) {
       ...
       function Save() {
           ...
           var publicHolday = $("#chkBoxPublicHoliday").is(":checked");

           if ($('#form_sample_1').validate().form() == false) {
               return false;
           }
           var v = "key=save" + "&id=" + id + "&descriptionEn=" + descriptionEn + "&descriptionAr=" + descriptionAr;
           v += "&fromDate=" + fromDate + "&toDate=" + toDate + "&recurring=" + recurring + "&remarks=" + remarks +"&publicHoliday=" + publicHolday;
