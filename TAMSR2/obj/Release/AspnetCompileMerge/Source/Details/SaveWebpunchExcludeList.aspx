<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SaveWebpunchExcludeList.aspx.cs" Inherits="TAMSR2.Details.SaveWebpunchExcludeList" %>



<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <title><%=Resources.Resource.webPunchExceptions %> - <%=Resources.Resource.applicationName %></title>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    <%=Resources.Resource.webPunchExceptions %>	
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                    ...
                    <li><a href='<%= Page.ResolveClientUrl("~/Emp/Employee-Webpunch-Exception") %>'><%=Resources.Resource.webPunch %></a></li>
            ...
            <div class="span12">
                ...
                <form action="#" id="form_sample_1" class="form-horizontal">
                    ...
                    <div class="row-fluid">
                        <div class="span6 ">
                            <div class="control-group">
                                <label class="control-label"><%=Resources.Resource.remarksEn %><span class="required">*</span></label>
                                <div class="controls">
                        ...
                        <div class="span6 ">
                            <div class="control-group">
                                <label class="control-label"><%=Resources.Resource.remarksAr %><span class="required">*</span></label>
                                <div class="controls">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            users.client.broadcastMessage = function (name, message) {
                if (name == "TAMSR2_Cmp_Webpunch_Exclude_List") {
                    //ReloadGrid();
                }
            };
            ...
            $.connection.hub.start().done(function () {
                $('#btnBroadCast').click(function () {
                    ...
                    users.server.send('TAMSR2_Cmp_Webpunch_Exclude_List', '');
        ...
        function CloseForm() {
            Clear();
            window.location = '<%= Page.ResolveClientUrl("~/Emp/Employee-Webpunch-Exception") %>';
            $("#divSuccessMsg").hide();
        }
        ...
        function LoadEmployeeList() {
            ...
            $.ajax({
                ...
                success: function (html) {
                    ...
                    var punchID = $('#spnWebpunch').text();
                    if (punchID != "0" && punchID != "MA==") {
                        Edit(punchID);
                    }
        ...
        function Save() {
            ...
            var v = "key=save" + "&id=" + id + "&fromDate=" + fromDate + "&toDate=" + toDate + "&employeeID=" + employeeID;
            v += "&status=" + status + "&descriptionEn=" + descriptionEn + "&descriptionAr=" + descriptionAr;
            ...
            $.ajax({
               ...
               success: function (html) {
                   if (html == '-1') {
                       ...
                       $('#btnBroadCast').click();
                       if ($('#spnWebpunch').text() != "" && $('#spnWebpunch').text() != "0" && $('#spnWebpunch').text() != "MA==") {
                           window.location = '<%= Page.ResolveClientUrl("~/Emp/Employee-Webpunch-Exception") %>';
                       }
                       Clear();
                   }
           ...
           init: function () {
               ...
               form1.validate({
                ...
                errorPlacement: function (error, element) { // render error placement for each input type
                    if (element.attr("name") == "emp" || element.attr("name") == "schLocation") { // for uniform checkboxes, insert the after the given container
