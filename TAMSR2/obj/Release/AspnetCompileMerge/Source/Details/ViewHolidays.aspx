<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewHolidays.aspx.cs" Inherits="TAMSR2.Details.ViewHolidays" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title><%=Resources.Resource.holidays %> - <%=Resources.Resource.applicationName %></title>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.holidays %></h4>
                        </div>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#"><%=Resources.Resource.holidays %></a></li>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="portlet box light-grey">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.holidays %></div>
                        <div class="tools">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="btn-group pull-<%= pullDirectionStr %>" style="">
                                <span id="spnAddButton" runat="server">
                                    <a id="btnAdd" onclick="return Clear()" href='<%= Page.ResolveClientUrl("~/Common/Save-Holiday/" + TAMSR2.CustomClasses.Encryption.Encrypt("0")) %>' class="btn green"><i class="icon-plus">&nbsp; <%=Resources.Resource.add %></i></a>
                                </span>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            <thead>
                              <tr style="background-color: #e8e3e3;">
                                    ...
                                    <th style="text-align: center;"><%=Resources.Resource.recurring %></th>
                                    <th style="text-align: center;"><%=Resources.Resource.publicHoliday %></th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var oTable = $('#sample_1').dataTable({
                ...
                "aaSorting": [[1, "desc"]],
                "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/HolidayPage.aspx?key=getAll") %>'
            });
