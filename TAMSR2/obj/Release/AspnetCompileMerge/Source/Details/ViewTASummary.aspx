<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewTASummary.aspx.cs" Inherits="TAMSR2.Details.ViewTASummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
        <title><%=Resources.Resource.taEvent %> - <%=Resources.Resource.applicationName %></title> <link href="assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
                             ...
                             <div class="row-fluid">
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number transactions"  data-percent="100"><span>Normal In</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Details/ViewTAEvents.aspx?orgID=&empID=&groupID=&fromDate=&toDate=") %>'> &nbsp;<%= Resources.Resource.taEvent %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number visits"  data-percent="100"><span>Normal Out</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Details/ViewTAEvents.aspx?orgID=&empID=&groupID=&fromDate=&toDate") %>'>  &nbsp; <%= Resources.Resource.taEvent %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number bounce"  data-percent="100"><span>Permission In</span></div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Details/ViewTAEvents.aspx?orgID=&empID=&groupID=&fromDate=&toDate=") %>'> &nbsp; <%= Resources.Resource.taEvent %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                                 </div>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number transactions"  data-percent="100"><span>Permission Out</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Details/ViewTAEvents.aspx?orgID=&empID=&groupID=&fromDate=&toDate=") %>'> &nbsp;<%= Resources.Resource.taEvent %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                            </div>
