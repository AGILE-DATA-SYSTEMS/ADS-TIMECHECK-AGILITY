<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewDevicesSummary.aspx.cs" Inherits="TAMSR2.Details.ViewDevicesSummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <title><%=Resources.Resource.devices %> - <%=Resources.Resource.applicationName %></title> <link href="assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title" style="margin: 0px;"><%=Resources.Resource.devices %> 					<small style="display: none;">statistics and more</small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                            ...
                            <li><a href="#"><%=Resources.Resource.devices %> </a></li>
                             ...
                             <div class="row-fluid">
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number transactions"  data-percent="05"><span>05- Enrollment Client</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Details/ViewReaders.aspx") %>'> &nbsp;<%= Resources.Resource.devices %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number visits"  data-percent="25"><span>25- Readers</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Details/ViewReaders.aspx") %>'>  &nbsp; <%= Resources.Resource.devices %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
