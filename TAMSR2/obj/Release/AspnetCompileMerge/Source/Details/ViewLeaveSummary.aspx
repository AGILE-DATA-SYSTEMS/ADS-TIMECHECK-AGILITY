<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewLeaveSummary.aspx.cs" Inherits="TAMSR2.Details.ViewLeaveSummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
        <title><%=Resources.Resource.leave %> - <%=Resources.Resource.applicationName %></title> <link href="assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- BEGIN PAGE CONTAINER-->
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title" style="margin: 0px;"><%=Resources.Resource.leave %> 					<small style="display: none;">statistics and more</small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                            ...
                            <li><a href="#"><%=Resources.Resource.leave %> </a></li>
            ...
            if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_GROUP) == true ||
                new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_EMPLOYEE) == true ||
                            ...
                            <%   if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_EMPLOYEE) == true)
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    ...
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Emp/Employees") %>'> &nbsp;<%= Resources.Resource.shortPermission %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    ...
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Leaves/Employee-Leaves") %>'>  &nbsp; <%= Resources.Resource.employeeLeaves %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              <% } if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_GROUP) == true)
                                 { %>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    ...
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Emp/Employee-Groups") %>'> &nbsp; <%= Resources.Resource.leaveApproval %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                                 </div>
                              <div class="row-fluid">
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number transactions"  data-percent="33"><span>3</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Leaves/Employee-Leaves") %>'> &nbsp;<%= Resources.Resource.permissionApproval %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                               <% } %>
                           </div>
