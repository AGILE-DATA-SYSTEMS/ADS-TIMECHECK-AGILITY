<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewEmpInfoSummary.aspx.cs" Inherits="TAMSR2.Details.ViewEmpInfoSummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <title><%=Resources.Resource.employee %> - <%=Resources.Resource.applicationName %></title> <link href="assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title" style="margin: 0px;"><%=Resources.Resource.employee %> 					<small style="display: none;">statistics and more</small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                            ...
                            <li><a href="#"><%=Resources.Resource.employee %> </a></li>
                            ...
                            <%   if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_EMPLOYEE) == true)
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number transactions"  data-percent="90"><span>309</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Emp/Employees") %>'> &nbsp;<%= Resources.Resource.employees %> <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              <% } if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_GROUP) == true)
                                 { %>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    <div class="number visits"  data-percent="25"><span>25</span> </div>
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Emp/Employee-Groups") %>'>  &nbsp; <%= Resources.Resource.employeeGroups %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                              <% } if (new TAMSR2.ObjectClasses.TAMSPrivilege().IsPrivileged(TAMSR2.ObjectClasses.TAMSPrivilege.VIEW_GROUP) == true)
                                 { %>
                              ...
                              <div class="span4">
                                 <div class="easy-pie-chart">
                                    ...
                                    <a class="title" href='<%= Page.ResolveClientUrl("~/Emp/Employee-Delegate") %>'> &nbsp; <%= Resources.Resource.delegation %>  <i class="m-icon-swapright"></i></a>
                                 </div>
                              </div>
                               <% } %>
                           </div>
