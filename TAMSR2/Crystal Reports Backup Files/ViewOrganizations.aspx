               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.applicationName %> <%=Resources.Resource.organizationTypes %></h4>
                     </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr>
                                 ...
                                 <th style="max-width: 100px !important;"><%=Resources.Resource.code %></th>
                                 <th><%=Resources.Resource.description %></th>
                                 <th style="max-width: 100px !important;"><%=Resources.Resource.type %></th>
                                 <th class="hidden-480"><%=Resources.Resource.parent %></th>
                                 <th style="max-width: 100px !important;"><%=Resources.Resource.updated %></th>
  ...
  <script src='../Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
           ...
           $.ajax({
               ...
               success: function (html) {
                   if (html != "") {
                       ...
                       $("#txtCode").val(j.Code);
                       $('#ddOrgParent option[value=' + j.ParentID + ']').attr('selected', 'selected');
                       $("#ddOrgParent").trigger("liszt:updated");
       ...
       function Save() {
           ...
           v += "&descriptionEn=" + descriptionEn + "&descriptionAr=" + descriptionAr + "&branchFlag=N";
