               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.applicationName %> <%=Resources.Resource.reason %></h4>
                     </div>
                     <div class="portlet-body form">
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal">
                           ...
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.reasonMode %></label>
                              <div class="controls">
                                 <input type="text" id="txtReasonMode" name="reasonMode" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.promptMsg %></label>
                              <div class="controls">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr>
                                 ...
                                 <th class="hidden-480"><%=Resources.Resource.reasonMode %></th>
                                 <th class="hidden-480"><%=Resources.Resource.promptMsg %></th>
                                 <th class="hidden-480"><%=Resources.Resource.deleteable %></th>
                                 <th class="hidden-480"><%=Resources.Resource.normalIn %></th>
                                 <th class="hidden-480"><%=Resources.Resource.normalOut %></th>
  ...
  <script src='../Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
           ...
           $.ajax({
               ...
               success: function (html) {
                   if (html != "") {
                       ...
                       $("#txtCode").val(j.Code);
                       $("#txtReasonMode").attr("value", j.ReasonMode);
       ...
       function Save() {
           ...
           var reasonMode = $("#txtReasonMode").val();
           ...
           v += "&promptMsg=" + promptMsg + "&reasonMode=" + reasonMode + "&deleteable=" + deleteable + "&orgID=" + orgID + "&type=" + type;
