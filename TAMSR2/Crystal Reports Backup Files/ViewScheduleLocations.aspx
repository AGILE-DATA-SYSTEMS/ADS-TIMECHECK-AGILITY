<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewScheduleLocations.aspx.cs" Inherits="TAMSR2.Details.ViewScheduleLocations" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <title><%=Resources.Resource.scheduleLocations %> - <%=Resources.Resource.applicationName %></title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.applicationName %> <%=Resources.Resource.scheduleLocations %></h4>
                     </div>
         ...
         <div class="container-fluid">
			...
			<h3 class="page-title">
									<%=Resources.Resource.scheduleLocations %> 
							</h3>
			<ul class="breadcrumb">
				<li>
					<i class="icon-home"></i>
				...
				<li><a href="#"><%=Resources.Resource.scheduleLocations %></a></li>					
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i><%=Resources.Resource.scheduleLocations %></div>
                        <div class="tools">
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           var oTable = $('#sample_1').dataTable({
               ...
               "aaSorting": [[1, "desc"]],
               "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/ScheduleLocationPage.aspx?key=getAll") %>'
           });
           ...
           users.client.broadcastMessage = function (name, message) {
               if (name == "TAMSR2_Cmp_SchLocations") {
                   ReloadGrid();
               }
           };
           ...
           $.connection.hub.start().done(function () {
               $('#btnBroadCast').click(function () {
                   ...
                   users.server.send('TAMSR2_Cmp_SchLocations', '');
