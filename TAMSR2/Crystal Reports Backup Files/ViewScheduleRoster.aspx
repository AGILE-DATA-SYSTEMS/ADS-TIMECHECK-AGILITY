...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <link rel="stylesheet" type="text/css" href="../assets/<%= languageStr %>/plugins/bootstrap-datepicker/css/datepicker.css" />
	...
	<style>
	    ...
	    .draggable { cursor: move; padding: 5px; margin: 10px; float: left; }
        .droppable { text-align: center !important; font-weight: bold; font-size: 12px; color: white; cursor: pointer;}
	    #sample_1 thead th, #sample_id tbody td{ padding: 3px !important; line-height: 15px !important;}
	</style>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.applicationName %> <%=Resources.Resource.monthlyRoster %></h4>
                     </div>
                        ...
                        <!-- END FORM-->
                          ...
                          <div style="width: 100%; overflow: scroll; overflow-y: hidden; padding: 20px 0px;">
                              <table class="table table-striped table-bordered table-hover" id="sample_1">
                                  <thead>
                                      <tr>
                                          <th style="width: 24px !important;"><input type="checkbox" class="group-checkable" data-set="#sample_1 .checkboxes"  /></th>
  ...
  <script src='../Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
       ...
       function ClearRoster() {
           ...
           $(".droppable").attr("schID", "-1");
           $(".droppable").removeAttr("code");
           $(".droppable").html("");
       }
