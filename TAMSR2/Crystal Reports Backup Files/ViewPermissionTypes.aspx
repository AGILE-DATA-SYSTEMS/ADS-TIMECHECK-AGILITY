               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.applicationName %> <%=Resources.Resource.permissionTypes %></h4>
                     </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr>
                                 ...
                                 <th class="hidden-480"><%=Resources.Resource.maxPermissions %></th>
                                 <th class="hidden-480"><%=Resources.Resource.maxMinutes %></th>
                                 <th class="hidden-480"><%=Resources.Resource.groupApply %></th>
  ...
  <script src='../Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           $("#liEmpPermissionType").addClass("active");
       ...
       function Save() {
           ...
           var v = "key=save" + "&id=" + id + "&code=" + code + "&orgID=" + orgID + "&reasonID=" + reasonID;
