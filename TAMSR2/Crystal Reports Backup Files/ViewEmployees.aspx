               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.applicationName %> <%=Resources.Resource.employee %></h4>
                     </div>
                     <div class="portlet-body form">
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal">
                           ...
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.maxPermissions %><span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" id="txtMaxPermissions" name="maxPermissions" data-required="1" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.maxMinutes %><span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" id="txtMaxMinutes" name="maxMinutes" data-required="1" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group">
                              <label class="control-label"><%=Resources.Resource.tcn %><span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" id="txtTcn" name="tcn" data-required="1" class="span6 m-wrap"/>
                              </div>
                           </div>
                           <div class="control-group">
                        ...
                        <div class="clearfix">
                           ...
                           <div class="btn-group pull-<%= pullDirectionStr %>" style="">
                              <span id="spnAddButton" runat="server" >
                                  <a id="btnAdd" href="SaveEmployeeDetails.aspx" class="btn green"><i class="icon-plus"> &nbsp; <%=Resources.Resource.add %></i></a> 
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr>
                                 ...
                                 <th class="hidden-480"><%=Resources.Resource.cardNo %></th>
                                 <th class="hidden-480"><%=Resources.Resource.email %></th>
                                 <th class="hidden-480"><%=Resources.Resource.remarks %></th>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           var oTable = $('#sample_1').dataTable({
               ...
               "aaSorting": [[1, "desc"]],
               "sAjaxSource": '<%= Page.ResolveClientUrl("../RequestPages/EmployeePage.aspx?key=getAll") %>'
           });
