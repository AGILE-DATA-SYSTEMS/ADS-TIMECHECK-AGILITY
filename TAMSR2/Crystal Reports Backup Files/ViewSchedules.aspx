               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.applicationName %> <%=Resources.Resource.schedules %></h4>
                     </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr>
                                 ...
                                 <th class="hidden-480"><%=Resources.Resource.flexible %></th>
                                 <th class="hidden-480"><%=Resources.Resource.graceIn %></th>
                                 <th class="hidden-480"><%=Resources.Resource.openShift %></th>
  ...
  <script src='../Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           $.connection.hub.start().done(function () {
               $('#btnBroadCast').click(function () {
                   ...
                   users.server.send('TAMSR2_Schedule', '');
           ...
           $.ajax({
               ...
               success: function (html) {
                   if (html != "") {
                       ...
                       $("#spnID").val(j.ID);
                       $("#txtInTime1").val(j.DescriptionEn);
                       $("#txtOutTime1").val(j.DescriptionAr);
                       $("#txtCode").val(j.Code);
                       $("#txtFlexible").val(j.flexible);
                       $("#txtGraceIn").val(j.graceIn);
                       ...
                       if (j.NightShiftFlag + "" == "Y" || j.nightShiftFlag + "" == "y") {
       ...
       function Save() {
           ...
           var inTime2 = $("#txtInTime1").val();
           var outTime2 = $("#txtOutTime1").val();
           var inTime3 = $("#txtInTime1").val();
           var outTime3 = $("#txtOutTime1").val();
           ...
           var v = "key=save" + "&id=" + id + "&code=" + code + "&orgID=" + orgID + "&schLocationID=" + schLocationID + "&openShift=" + openShift;
           v += "&inTime1=" + inTime1 + "&outTime1=" + outTime1 + "&inTime2=" + inTime2 + "&outTime2=" + outTime2 + "&inTime3=" + inTime3 + "&outTime3=" + outTime3;
           v += "&flexible=" + flexible + "&graceIn=" + graceIn + "&nightShift=" + nightShift;
           alert(v);
           return;
           $.ajax({
               type: 'POST',
