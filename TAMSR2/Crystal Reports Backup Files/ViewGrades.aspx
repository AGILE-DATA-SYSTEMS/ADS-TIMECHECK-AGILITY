               ...
               <div class="span12">
                  ...
                  <div class="portlet box purple">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>&nbsp; <%=Resources.Resource.applicationName %> <%=Resources.Resource.grades %></h4>
                     </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                           <thead>
                              <tr>
                                 ...
                                 <th style="max-width: 100px !important;"><%=Resources.Resource.noOfCl %></th>
                                 <th style="max-width: 100px !important;"><%=Resources.Resource.noOfSl %></th>
                                 <th style="max-width: 100px !important;"><%=Resources.Resource.noOfAl %></th>
                                 <th><%=Resources.Resource.updated %></th>
  ...
  <script src='../Assets/<%= languageStr %>/plugins/jquery-validation/dist/jquery.validate.min.js' type='text/javascript'></script>
   ...
   <script type="text/javascript">
      ...
      function Clear() {
          ...
          $("#chkboxOvertimeEligible").removeAttr("checked");
          $("#uniform-chkboxOvertimeEligible span").removeClass("checked");
      ...
      function Delete() {
       ...
       function Save() {
           ...
           var v = "key=save" + "&id=" + id + "&code=" + code + "&orgID=" + orgID + "&overtimeEligible=" + overtimeEligible;
